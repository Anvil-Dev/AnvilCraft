...
public class ModItemGroups {
    public static final RegistryEntry<CreativeModeTab> ANVILCRAFT_TOOL = REGISTRATE
            .defaultCreativeTab("tools", builder -> builder
                    ...
                    .displayItems((ctx, entries) -> {
                        ...
                        entries.accept(
                                ModItems.ROYAL_STEEL_UPGRADE_SMITHING_TEMPLATE.get().getDefaultInstance());
    ...
    private static @NotNull ItemStack createMaxLevelBook(
            @NotNull RegistryEntry<? extends Enchantment> enchantment) {
