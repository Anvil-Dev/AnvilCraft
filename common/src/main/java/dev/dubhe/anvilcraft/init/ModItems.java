...
public class ModItems {
    ...
    public static final ItemEntry<? extends PickaxeItem> AMETHYST_PICKAXE = REGISTRATE
            ...
            .recipe((ctx, provider) -> ShapedTagRecipeBuilder.shaped(
                            RecipeCategory.TOOLS, ctx.get().asItem().getDefaultInstance())
                    .pattern("AAA")
                    .pattern(" B ")
                    .pattern(" B ")
    ...
    public static final ItemEntry<Item> FLOUR = REGISTRATE
            ...
            .recipe((ctx, provider) -> AnvilRecipe.Builder.create(
                            RecipeCategory.MISC, ctx.get().getDefaultInstance())
    ...
    public static final ItemEntry<Item> HARDEND_RESIN =
            REGISTRATE.item("hardend_resin", Item::new).register();
    public static final ItemEntry<Item> WOOD_FIBER =
            REGISTRATE.item("wood_fiber", Item::new).register();
    public static final ItemEntry<Item> CIRCUIT_BOARD =
            REGISTRATE.item("circuit_board", Item::new).register();
    public static final ItemEntry<Item> PRISMARINE_BLADE =
            REGISTRATE.item("prismarine_blade", Item::new).register();
    ...
    public static final ItemEntry<EmptyCapacitorItem> CAPACITOR_EMPTY = REGISTRATE
            ...
            .tag(ModItemTags.CAPACITOR)
            .recipe((ctx, provider) -> ShapedTagRecipeBuilder.shaped(
                            RecipeCategory.TOOLS, ctx.get().getDefaultInstance())
                    .pattern("ABA")
                    .pattern("ACA")
                    .pattern("ABA")
                    ...
                    .unlockedBy(
                            ...
                            RegistrateRecipeProvider.has(Items.COPPER_INGOT))
                    .unlockedBy(
                            AnvilCraftDatagen.hasItem(Items.TERRACOTTA),
                            RegistrateRecipeProvider.has(Items.TERRACOTTA))
                    .save(provider))
            .register();
                        ...
                        .save(
                                ...
                                AnvilCraft.of("timewarp/"
                                        + BuiltInRegistries.ITEM
                                                .getKey(Items.ANCIENT_DEBRIS.asItem())
                                                .getPath()
                                        + "_first"));
            })
            .register();
            ...
            .recipe((ctx, provider) -> {
                ...
                AnvilRecipe.Builder.create(RecipeCategory.MISC, ctx.get().getDefaultInstance())
                        ...
                        .save(
                                provider,
                                AnvilCraft.of("heating/"
                                        + BuiltInRegistries.ITEM.getKey(ctx.get().asItem()).getPath() + "_forge"));
            })
            .register();
    ...
    public static final ItemEntry<Item> NETHERITE_CRYSTAL_NUCLEUS = REGISTRATE
            ...
            .recipe((ctx, provider) -> {
                ...
                TimeWarpRecipesLoader.timeWarp(
                        RecipeItem.of(ctx.get()), RecipeItem.of(Items.ANCIENT_DEBRIS));
            })
            .register();
