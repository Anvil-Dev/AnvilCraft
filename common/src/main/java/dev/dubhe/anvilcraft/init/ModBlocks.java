...
public class ModBlocks {
    public static final BlockEntry<? extends Block> STAMPING_PLATFORM = REGISTRATE
            ...
            .recipe((ctx, provider) -> {
                ...
                ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ctx.get())
                        ...
                        .define('B', Items.IRON_INGOT)
                        .unlockedBy(
                                "has_" + ModItemTags.IRON_PLATES_FORGE.location().getPath(),
    ...
    public static final BlockEntry<? extends Block> ROYAL_STEEL_BLOCK = REGISTRATE
            ...
            .recipe((ctx, provider) -> {
                ...
                AnvilRecipe.Builder.create(RecipeCategory.MISC)
                        ...
                        .unlockedBy(
                                AnvilCraftDatagen.hasItem(Items.IRON_BLOCK),
                                AnvilCraftDatagen.has(Items.IRON_BLOCK))
                        .unlockedBy(
                                AnvilCraftDatagen.hasItem(Items.DIAMOND_BLOCK),
    ...
    public static final BlockEntry<? extends Block> AMBER_BLOCK = REGISTRATE
            ...
            .recipe((ctx, provider) -> {
                ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ctx.get())
                        ...
                        .save(provider);
                HasItem.ModItemPredicate item = HasItem.ModItemPredicate.of(ModBlocks.RESIN_BLOCK)
                        .withCount(MinMaxBounds.Ints.atLeast(1));
                HasItem hasItem = new HasItemIngredient(new Vec3(0.0, -1.0, 0.0), item)
                        .notHasTag("BlockEntityTag.entity");
                AnvilRecipe.Builder.create(RecipeCategory.MISC)
                        .icon(ctx.get())
                        ...
                        .unlockedBy(
                                AnvilCraftDatagen.hasItem(ctx.get()), AnvilCraftDatagen.has(ModBlocks.RESIN_BLOCK))
                        .save(
                                provider,
    ...
    public static final BlockEntry<MobAmberBlock> MOB_AMBER_BLOCK = REGISTRATE
            ...
            .recipe((ctx, provider) -> {
                ...
                RecipeOutcome spawnItem0 = new SpawnItem(
                                new Vec3(0.0, -1.0, 0.0), 1.0, ctx.get().getDefaultInstance())
                        .loadItemData("resin");
                AnvilRecipe.Builder.create(RecipeCategory.MISC)
                        .icon(ctx.get())
                        .type(AnvilRecipeType.TIMEWARP)
                ...
                HasItem.ModItemPredicate monster = HasItem.ModItemPredicate.of(ModBlocks.RESIN_BLOCK)
                        .withCount(MinMaxBounds.Ints.atLeast(1))
                        .withNbt(tag);
                ...
                RecipeOutcome spawnItem1 = new SpawnItem(
                                new Vec3(0.0, -1.0, 0.0), 0.95, ctx.get().getDefaultInstance())
                        .loadItemData("resin");
    ...
    public static final BlockEntry<FallingBlock> NETHER_DUST = REGISTRATE
            ...
            .recipe(
                    (ctx, provider) -> BlockSmashRecipesLoader.smash(Blocks.NETHERRACK, ctx.get(), provider))
            .tag(BlockTags.MINEABLE_WITH_SHOVEL)
            .register();
