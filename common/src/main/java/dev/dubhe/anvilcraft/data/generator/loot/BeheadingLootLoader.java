...
public class BeheadingLootLoader {
    ...
    public static final ResourceLocation WITHER_SKELETON_LOOT =
            AnvilCraft.of("entities/beheading/wither_skeleton");
    ...
    public static final ResourceLocation ENDER_DRAGON_LOOT =
            AnvilCraft.of("entities/beheading/ender_dragon");
    ...
    public static ResourceLocation getBeheading(EntityType<?> type) {
        return BEHEADING.getOrDefault(
                type,
                AnvilCraft.of(
                        "entities/beheading/" + BuiltInRegistries.ENTITY_TYPE.getKey(type).getPath()));
    }
