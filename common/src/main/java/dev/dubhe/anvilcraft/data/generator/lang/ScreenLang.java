...
public class ScreenLang {
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("screen.anvilcraft.button.record.tooltip", "When activated, the synthesizer must fill all slots (including the cover) in order to start crafting");
        ...
        provider.add("screen.anvilcraft.royal_steel_upgrade_smithing_template", "Royal Steel Upgrade Smithing Template");
