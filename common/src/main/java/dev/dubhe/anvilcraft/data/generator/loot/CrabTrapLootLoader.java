...
public class CrabTrapLootLoader {
    private static final LootItemCondition.Builder IN_RIVER = LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.RIVER))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.FROZEN_RIVER)));

    private static final LootItemCondition.Builder IN_OCEAN = LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.OCEAN))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.COLD_OCEAN)))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.DEEP_OCEAN)))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.DEEP_COLD_OCEAN)))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.FROZEN_OCEAN)))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.DEEP_FROZEN_OCEAN)));

    private static final LootItemCondition.Builder IN_WARM_OCEAN = LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.WARM_OCEAN))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.LUKEWARM_OCEAN)))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.DEEP_LUKEWARM_OCEAN)));

    private static final LootItemCondition.Builder IN_SWAMP = LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.SWAMP))
            .or(LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.MANGROVE_SWAMP)));

    private static final LootItemCondition.Builder IN_JUNGLE = LocationCheck.checkLocation(
                    LocationPredicate.Builder.location().setBiome(Biomes.JUNGLE))
            .or(LocationCheck.checkLocation(
    ...
    private static final LootTable.Builder COMMON = LootTable.lootTable()
    ...
    private static final LootTable.Builder RIVER = LootTable.lootTable()
            .withPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0f))
    ...
    private static final LootTable.Builder OCEAN = LootTable.lootTable()
            .withPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0f))
    ...
    private static final LootTable.Builder WARM_OCEAN = LootTable.lootTable()
            .withPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0f))
    ...
    private static final LootTable.Builder SWAMP = LootTable.lootTable()
            .withPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0f))
    ...
    private static final LootTable.Builder JUNGLE = LootTable.lootTable()
            .withPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1.0f))
