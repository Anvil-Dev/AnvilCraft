...
public class VanillaRecipesLoader {
    ...
    public static void init(RegistrateRecipeProvider provider) {
        ...
        SimpleCookingRecipeBuilder.campfireCooking(
                        Ingredient.of(ModItemTags.DOUGH), RecipeCategory.FOOD, Items.BREAD, 0.35f, 600)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.DOUGH.get()), AnvilCraftDatagen.has(ModItems.DOUGH))
                .save(provider, AnvilCraft.of("campfire_cooking_bread"));
        SimpleCookingRecipeBuilder.smoking(
                        Ingredient.of(ModItemTags.DOUGH), RecipeCategory.FOOD, Items.BREAD, 0.35f, 100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.DOUGH.get()), AnvilCraftDatagen.has(ModItems.DOUGH))
        ...
        SimpleCookingRecipeBuilder.campfireCooking(
                        Ingredient.of(ModItemTags.DOUGH_FORGE), RecipeCategory.FOOD, Items.BREAD, 0.35f, 600)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.DOUGH.get()), AnvilCraftDatagen.has(ModItems.DOUGH))
                .save(provider, AnvilCraft.of("campfire_cooking_bread_forge"));
        SimpleCookingRecipeBuilder.smoking(
                        Ingredient.of(ModItemTags.DOUGH_FORGE), RecipeCategory.FOOD, Items.BREAD, 0.35f, 100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.DOUGH.get()), AnvilCraftDatagen.has(ModItems.DOUGH))
                .save(provider, AnvilCraft.of("smoking_bread_forge"));
        SimpleCookingRecipeBuilder.generic(
                        Ingredient.of(ModItemTags.DOUGH_FORGE),
                        RecipeCategory.FOOD,
                        Items.BREAD,
                        0.35f,
                        600,
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                ...
                ModBlocks.CUT_ROYAL_STEEL_STAIRS,
                ModBlocks.CUT_ROYAL_STEEL_BLOCK);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.CUT_ROYAL_STEEL_SLAB,
                ModBlocks.CUT_ROYAL_STEEL_BLOCK,
                2);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.SMOOTH_ROYAL_STEEL_BLOCK,
                ModBlocks.ROYAL_STEEL_BLOCK,
                4);
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.POLISHED_HEAVY_IRON_BLOCK,
                ModBlocks.HEAVY_IRON_BLOCK);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.POLISHED_HEAVY_IRON_STAIRS,
                ModBlocks.HEAVY_IRON_BLOCK);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.CUT_HEAVY_IRON_BLOCK,
                ModBlocks.HEAVY_IRON_BLOCK,
                4);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.CUT_HEAVY_IRON_SLAB,
                ModBlocks.HEAVY_IRON_BLOCK,
                8);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
        ...
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.HEAVY_IRON_PLATE,
                ModBlocks.HEAVY_IRON_BLOCK,
                8);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.HEAVY_IRON_COLUMN,
                ModBlocks.HEAVY_IRON_BLOCK,
                4);
        VanillaRecipeProvider.stonecutterResultFromBase(
                provider,
                RecipeCategory.BUILDING_BLOCKS,
                ModBlocks.HEAVY_IRON_BEAM,
                ModBlocks.HEAVY_IRON_BLOCK,
                4);
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        ModItems.ROYAL_STEEL_PICKAXE.get())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModItems.AMETHYST_PICKAXE.asItem()),
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        Ingredient.of(ModItems.ROYAL_STEEL_INGOT.get()),
                        RecipeCategory.TOOLS,
                        ModItems.ROYAL_STEEL_AXE.get())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModItems.AMETHYST_AXE.asItem()),
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        Ingredient.of(ModItems.ROYAL_STEEL_INGOT.get()),
                        RecipeCategory.TOOLS,
                        ModItems.ROYAL_STEEL_HOE.get())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModItems.AMETHYST_HOE.asItem()),
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        Ingredient.of(ModItems.ROYAL_STEEL_INGOT.get()),
                        RecipeCategory.TOOLS,
                        ModItems.ROYAL_STEEL_SHOVEL.get())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModItems.AMETHYST_SHOVEL.asItem()),
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        Ingredient.of(ModItems.ROYAL_STEEL_INGOT.get()),
                        RecipeCategory.TOOLS,
                        ModItems.ROYAL_STEEL_SWORD.get())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModItems.AMETHYST_SWORD.asItem()),
        ...
        SmithingTransformRecipeBuilder.smithing(
                        ...
                        RecipeCategory.TOOLS,
                        ModBlocks.ROYAL_GRINDSTONE.asItem())
                .unlocks(
                        AnvilCraftDatagen.hasItem(ModBlocks.ROYAL_STEEL_BLOCK.asItem()),
                        AnvilCraftDatagen.has(ModBlocks.ROYAL_STEEL_BLOCK))
                .unlocks(
                        AnvilCraftDatagen.hasItem(Items.GRINDSTONE), AnvilCraftDatagen.has(Items.GRINDSTONE))
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(
                        ...
                        AnvilCraftDatagen.has(ModBlocks.ROYAL_STEEL_BLOCK))
                .unlocks(
                        AnvilCraftDatagen.hasItem(Items.SMITHING_TABLE),
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.DISCHARGER)
                ...
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.CHARGER), AnvilCraftDatagen.has(ModBlocks.CHARGER))
        ...
        SimpleCookingRecipeBuilder.smelting(
                        Ingredient.of(ModItems.RAW_ZINC), RecipeCategory.MISC, ModItems.ZINC_INGOT, 1, 1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_ZINC.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_ZINC))
                .save(provider, AnvilCraft.of("zinc_ingot_from_raw_zinc"));

        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ModItems.RAW_ZINC), RecipeCategory.MISC, ModItems.ZINC_INGOT, 1, 500)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_ZINC.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_ZINC))
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_ZINC_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        Ingredient.of(ModItems.RAW_TIN), RecipeCategory.MISC, ModItems.TIN_INGOT, 1, 1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_TIN.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_TIN))
                .save(provider, AnvilCraft.of("tin_ingot_from_raw_tin"));

        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ModItems.RAW_TIN), RecipeCategory.MISC, ModItems.TIN_INGOT, 1, 500)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_TIN.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_TIN))
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_TIN_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_TITANIUM.get()),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_TITANIUM_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_TUNGSTEN.get()),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_TUNGSTEN_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        Ingredient.of(ModItems.RAW_LEAD), RecipeCategory.MISC, ModItems.LEAD_INGOT, 1, 1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_LEAD.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_LEAD))
                .save(provider, AnvilCraft.of("lead_ingot_from_raw_lead"));

        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ModItems.RAW_LEAD), RecipeCategory.MISC, ModItems.LEAD_INGOT, 1, 500)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_LEAD.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_LEAD))
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_LEAD_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        Ingredient.of(ModItems.RAW_SILVER), RecipeCategory.MISC, ModItems.SILVER_INGOT, 1, 1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_SILVER.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_SILVER))
                .save(provider, AnvilCraft.of("silver_ingot_from_raw_silver"));

        SimpleCookingRecipeBuilder.blasting(
                        Ingredient.of(ModItems.RAW_SILVER), RecipeCategory.MISC, ModItems.SILVER_INGOT, 1, 500)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_SILVER.get()),
                        AnvilCraftDatagen.has(ModItems.RAW_SILVER))
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_SILVER_ORE),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        1000)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModItems.RAW_URANIUM.get()),
        ...
        SimpleCookingRecipeBuilder.smelting(
                        ...
                        100)
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(ModBlocks.DEEPSLATE_URANIUM_ORE),
