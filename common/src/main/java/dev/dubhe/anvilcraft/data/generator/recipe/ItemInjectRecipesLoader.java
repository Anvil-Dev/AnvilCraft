...
public class ItemInjectRecipesLoader {
    ...
    public static void init(RegistrateRecipeProvider provider) {
        ...
        itemInject(
                RecipeItem.of(Items.RAW_COPPER_BLOCK, 3), Blocks.DEEPSLATE, Blocks.DEEPSLATE_COPPER_ORE);
        ...
        itemInject(
                ModBlocks.RAW_TITANIUM.asItem(), Blocks.DEEPSLATE, ModBlocks.DEEPSLATE_TITANIUM_ORE.get());
        itemInject(
                ModBlocks.RAW_TUNGSTEN.asItem(), Blocks.DEEPSLATE, ModBlocks.DEEPSLATE_TUNGSTEN_ORE.get());
        itemInject(ModBlocks.RAW_LEAD.asItem(), Blocks.DEEPSLATE, ModBlocks.DEEPSLATE_LEAD_ORE.get());
        itemInject(
                ModBlocks.RAW_SILVER.asItem(), Blocks.DEEPSLATE, ModBlocks.DEEPSLATE_SILVER_ORE.get());
        itemInject(
                ModBlocks.RAW_URANIUM.asItem(), Blocks.DEEPSLATE, ModBlocks.DEEPSLATE_URANIUM_ORE.get());
    }
    ...
    public static void itemInject(
        ...
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                ...
                .save(
                        provider,
                        AnvilCraft.of(
                                "item_inject/" + BuiltInRegistries.BLOCK.getKey(resBlock).getPath()));
    }

    public static void itemInject(@NotNull Item item, @NotNull Block block, @NotNull Block resBlock) {
