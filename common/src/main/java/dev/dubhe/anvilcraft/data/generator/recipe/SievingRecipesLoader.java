...
public class SievingRecipesLoader {
    ...
    public static void init(RegistrateRecipeProvider provider) {
        ...
        sieving(Items.SOUL_SAND, RecipeItem.of(Items.NETHER_WART, 0.005));
        sieving(Items.GRAVEL, RecipeItem.of(Items.FLINT, 0.25), RecipeItem.of(Items.IRON_NUGGET, 0.05));
        sieving(
                Items.SAND, RecipeItem.of(Items.CLAY_BALL, 0.25), RecipeItem.of(Items.GOLD_NUGGET, 0.05));
        sieving(
                Items.RED_SAND,
     ...
     * @param outputs 输出物品
     */
    public static void sieving(ItemLike item, RecipeItem... outputs) {
        ...
        builder.save(
                provider,
                AnvilCraft.of("sieving/" + BuiltInRegistries.ITEM.getKey(item.asItem()).getPath()));
    }
}
