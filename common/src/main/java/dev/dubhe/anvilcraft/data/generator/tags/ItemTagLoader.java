...
public class ItemTagLoader {
    ...
    public static void init(@NotNull RegistrateTagsProvider<Item> provider) {
        provider
                .addTag(ModItemTags.PLATES)
                .setReplace(false)
                .add(Items.HEAVY_WEIGHTED_PRESSURE_PLATE)
                .add(Items.LIGHT_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.IRON_PLATES)
                .setReplace(false)
                .add(Items.HEAVY_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.GOLD_PLATES)
                .setReplace(false)
                .add(Items.LIGHT_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.PLATES_FORGE)
                .setReplace(false)
                .add(Items.HEAVY_WEIGHTED_PRESSURE_PLATE)
                .add(Items.LIGHT_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.IRON_PLATES_FORGE)
                .setReplace(false)
                .add(Items.HEAVY_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.GOLD_PLATES_FORGE)
                .setReplace(false)
                .add(Items.LIGHT_WEIGHTED_PRESSURE_PLATE);
        provider
                .addTag(ModItemTags.ROYAL_STEEL_PICKAXE_BASE)
                .setReplace(false)
        ...
        provider
                .addTag(ModItemTags.ROYAL_STEEL_AXE_BASE)
                .setReplace(false)
        ...
        provider
                .addTag(ModItemTags.ROYAL_STEEL_HOE_BASE)
                .setReplace(false)
        ...
        provider
                .addTag(ModItemTags.ROYAL_STEEL_SWORD_BASE)
                .setReplace(false)
        ...
        provider
                .addTag(ModItemTags.ROYAL_STEEL_SHOVEL_BASE)
                .setReplace(false)
        ...
        provider
                .addTag(ModItemTags.FORGE_RAW_ORES)
                .setReplace(false)
                .add(ModItems.RAW_ZINC.get())
                .add(ModItems.RAW_TIN.get())
                .add(ModItems.RAW_TITANIUM.get())
