...
public class SqueezeRecipesLoader {
    ...
    public static void init(RegistrateRecipeProvider provider) {
        ...
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                ...
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(Blocks.MOSS_BLOCK.asItem()),
        ...
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                ...
                .save(
                        provider,
                        AnvilCraft.of("daub/"
                                + BuiltInRegistries.BLOCK.getKey(Blocks.MOSSY_STONE_BRICKS).getPath()));
    ...
    public static void waxed(@NotNull Block block, RegistrateRecipeProvider provider) {
        ...
        if (waxed.isPresent()) {
            ...
            AnvilRecipe.Builder.create(RecipeCategory.MISC)
                    ...
                    .unlockedBy(
                            AnvilCraftDatagen.hasItem(Blocks.HONEYCOMB_BLOCK.asItem()),
                            AnvilCraftDatagen.has(Blocks.HONEYCOMB_BLOCK.asItem()))
                    .save(
                            provider,
                            AnvilCraft.of(
                                    "daub/" + BuiltInRegistries.BLOCK.getKey(state.getBlock()).getPath()));
        }
    }
    ...
    public static void squeeze(
        ...
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                ...
                .setBlock(
                        ...
                        block2.defaultBlockState().setValue(LayeredCauldronBlock.LEVEL, 1))
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(block.asItem()), AnvilCraftDatagen.has(block.asItem()))
                .save(
                        provider,
                        AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_"
                                + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_1"));
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .type(AnvilRecipeType.SQUEEZE)
                .hasBlock(block)
                ...
                .setBlock(
                        new Vec3(0.0, -2.0, 0.0),
                        block2.defaultBlockState().setValue(LayeredCauldronBlock.LEVEL, 2))
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(block.asItem()), AnvilCraftDatagen.has(block.asItem()))
                .save(
                        provider,
                        AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_"
                                + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_2"));
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .type(AnvilRecipeType.SQUEEZE)
                .hasBlock(block)
                ...
                .setBlock(
                        new Vec3(0.0, -2.0, 0.0),
                        block2.defaultBlockState().setValue(LayeredCauldronBlock.LEVEL, 3))
                .unlockedBy(
                        AnvilCraftDatagen.hasItem(block.asItem()), AnvilCraftDatagen.has(block.asItem()))
                .save(
                        provider,
                        AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_"
                                + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_3"));
    }
}
