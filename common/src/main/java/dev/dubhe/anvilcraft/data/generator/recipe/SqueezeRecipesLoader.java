...
public class SqueezeRecipesLoader {
    ...
    public static void init(RegistrateRecipeProvider provider)  {
        ...
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                ...
                .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.MOSS_BLOCK.asItem()), AnvilCraftDatagen.has(Blocks.MOSS_BLOCK.asItem()))
                .save(provider, AnvilCraft.of("daub/" + BuiltInRegistries.BLOCK.getKey(Blocks.MOSSY_COBBLESTONE).getPath()));
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .hasBlock(Blocks.MOSS_BLOCK)
                .hasBlock(new Vec3(0.0, -2.0, 0.0), Blocks.STONE_BRICKS)
                .setBlock(new Vec3(0.0, -2.0, 0.0), Blocks.MOSSY_STONE_BRICKS)
                .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.MOSS_BLOCK.asItem()), AnvilCraftDatagen.has(Blocks.MOSS_BLOCK.asItem()))
                .save(provider, AnvilCraft.of("daub/" + BuiltInRegistries.BLOCK.getKey(Blocks.MOSSY_STONE_BRICKS).getPath()));
    ...
    public static void waxed(@NotNull Block block, RegistrateRecipeProvider provider) {
        ...
        if (waxed.isPresent()) {
            ...
            AnvilRecipe.Builder.create(RecipeCategory.MISC)
                    ...
                    .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.HONEYCOMB_BLOCK.asItem()), AnvilCraftDatagen.has(Blocks.HONEYCOMB_BLOCK.asItem()))
                    .save(provider, AnvilCraft.of("daub/" + BuiltInRegistries.BLOCK.getKey(state.getBlock()).getPath()));
        }
    }

    public static void squeeze(@NotNull Block block, @NotNull Block block1, @NotNull Block block2, RegistrateRecipeProvider provider) {
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .hasBlock(block)
                ...
                .save(provider, AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_" + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_1"));
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .hasBlock(block)
                ...
                .unlockedBy(AnvilCraftDatagen.hasItem(block.asItem()), AnvilCraftDatagen.has(block.asItem()))
                .save(provider, AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_" + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_2"));
        AnvilRecipe.Builder.create(RecipeCategory.MISC)
                .hasBlock(block)
                ...
                .unlockedBy(AnvilCraftDatagen.hasItem(block.asItem()), AnvilCraftDatagen.has(block.asItem()))
                .save(provider, AnvilCraft.of("squeeze/" + BuiltInRegistries.BLOCK.getKey(block).getPath() + "_" + BuiltInRegistries.BLOCK.getKey(block2).getPath() + "_3"));
    }
}
