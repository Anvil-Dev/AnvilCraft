...
public class CorruptedBeaconRenderer implements BlockEntityRenderer<CorruptedBeaconBlockEntity> {
    ...
    private static void renderPart(
        ...
        CorruptedBeaconRenderer.renderQuad(
                matrix4f, matrix3f, consumer, red, green, blue, alpha, minY, maxY, x0, z0, x1, z1, minV,
                maxV);
        CorruptedBeaconRenderer.renderQuad(
                matrix4f, matrix3f, consumer, red, green, blue, alpha, minY, maxY, x3, z3, x2, z2, minV,
                maxV);
        CorruptedBeaconRenderer.renderQuad(
                matrix4f, matrix3f, consumer, red, green, blue, alpha, minY, maxY, x1, z1, x3, z3, minV,
                maxV);
        CorruptedBeaconRenderer.renderQuad(
                matrix4f, matrix3f, consumer, red, green, blue, alpha, minY, maxY, x2, z2, x0, z0, minV,
                maxV);
    }
    ...
    private static void renderQuad(
            ...
            float minV,
            float maxV) {
        CorruptedBeaconRenderer.addVertex(
                pose, normal, consumer, red, green, blue, alpha, maxY, minX, minZ, (float) 1.0, minV);
        CorruptedBeaconRenderer.addVertex(
                pose, normal, consumer, red, green, blue, alpha, minY, minX, minZ, (float) 1.0, maxV);
        CorruptedBeaconRenderer.addVertex(
                pose, normal, consumer, red, green, blue, alpha, minY, maxX, maxZ, (float) 0.0, maxV);
        CorruptedBeaconRenderer.addVertex(
                pose, normal, consumer, red, green, blue, alpha, maxY, maxX, maxZ, (float) 0.0, minV);
    }
