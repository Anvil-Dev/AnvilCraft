...
public class AutoCrafterScreen extends BaseMachineScreen<BatchCrafterMenu> implements IFilterScreen<BatchCrafterMenu> {
    ...
    public AutoCrafterScreen(BatchCrafterMenu menu, Inventory playerInventory, Component title) {
