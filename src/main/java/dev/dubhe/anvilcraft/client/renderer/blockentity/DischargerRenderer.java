...
public class DischargerRenderer extends BaseShowItemRenderer<DischargerBlockEntity, BaseShowItemRenderState> {
    public DischargerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
