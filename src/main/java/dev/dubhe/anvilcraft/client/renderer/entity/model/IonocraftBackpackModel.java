...
public class IonoCraftBackpackModel extends HumanoidModel<HumanoidRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Clear head, arms, legs — only keep the body part for the backpack.
        // "hat" must be a child of "head": HumanoidModel constructor does this.hat = this.head.getChild("hat")
        ...
        rightArm1.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 14)
                .addBox(-5.5F, -5.0F, 0.0F, 11.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0406F, -1.0028F, 0.072F)
        );
