...
public class MDItemCompressRecipeComponent extends MDBaseAnvilRecipeComponent {
    @Getter
    ...
    public MDItemCompressRecipeComponent(ItemCompressRecipe recipe, boolean enableAlignCenter) {
