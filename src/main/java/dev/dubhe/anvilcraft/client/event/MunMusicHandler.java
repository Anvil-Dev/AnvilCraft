...
public final class MunMusicHandler {
    ...
    public static void onSelectMusic(SelectMusicEvent event) {
        ...
        if (playingMusic != null && isMunMusic(playingMusic)) {
            ...
            selectedMusic = music(!playingMusic.getIdentifier().equals(ModSoundEvents.ABOVE_THE_MOON_DUST.get().location()));
    ...
    private static boolean isMunMusic(@Nullable SoundInstance sound) {
        return sound != null && (sound.getIdentifier().equals(ModSoundEvents.ABOVE_THE_MOON_DUST.get().location())
            || sound.getIdentifier().equals(ModSoundEvents.FAR_SIDE_GLOW.get().location()));
    }
