...
public class ModSoundDefinitionsProvider extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        this.add(
            ModSoundEvents.BURNING_HEATER.get(), SoundDefinitionsProvider.definition()
        ...
        this.add(
            ModSoundEvents.PLASMA_JET_LAVA.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.plasma_jet_lava")
                .with(SoundDefinitionsProvider.sound(
                    Identifier.withDefaultNamespace("block.lava.extinguish"),
                    SoundDefinition.SoundType.EVENT
                ))
        );

        this.add(
            ModSoundEvents.GIANT_ANVIL_LAND.get(), SoundDefinitionsProvider.definition()
        ...
        this.add(
            ModSoundEvents.GIANT_ANVIL_SHOCK.get(), SoundDefinitionsProvider.definition()
        ...
        this.add(
            ModSoundEvents.GIANT_ANVIL_RESIN_SHOCK.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.giant_anvil_resin_shock")
                .with(SoundDefinitionsProvider.sound(
                    Identifier.withDefaultNamespace("block.slime_block.break"),
                    SoundDefinition.SoundType.EVENT
                ))
        );

        this.add(
            ModSoundEvents.NEOFORGE_LAND.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.entity.fox.ambient")
                .with(
                    SoundDefinitionsProvider.sound(Identifier.withDefaultNamespace("entity.fox.ambient"), SoundDefinition.SoundType.EVENT))
        );

        this.add(
            ModSoundEvents.TESLA_TOWER_STRIKE.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.tesla_tower_strike")
                .with(SoundDefinitionsProvider.sound(AnvilCraft.of("tesla_tower_strike")))
        );

        this.add(
            ModSoundEvents.SMART_BLOCK_PLACER_EXTEND.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.smart_block_placer_extend")
                .with(
                    SoundDefinitionsProvider.sound(Identifier.withDefaultNamespace("block.piston.extend"), SoundDefinition.SoundType.EVENT))
        );

        this.add(
            ModSoundEvents.SMART_BLOCK_PLACER_RETRACT.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.smart_block_placer_retract")
                .with(SoundDefinitionsProvider.sound(
                    Identifier.withDefaultNamespace("block.piston.contract"),
                    SoundDefinition.SoundType.EVENT
                ))
        );

        this.add(
            ModSoundEvents.SMART_BLOCK_PLACER_SHULKER_OPEN.get(), SoundDefinitionsProvider.definition()
                .subtitle("subtitles.anvilcraft.smart_block_placer_shulker_open")
                .with(SoundDefinitionsProvider.sound(
                    Identifier.withDefaultNamespace("block.shulker_box.open"),
                    SoundDefinition.SoundType.EVENT
                ))
        );

        this.add(
            ModSoundEvents.ANVIL_HAMMER_ROTATE_BLOCK.get(), SoundDefinitionsProvider.definition()
