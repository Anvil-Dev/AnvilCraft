...
public class ShapedTagRecipeBuilder
     ...
     * 创建新的有序配方生成器。
     */
    public static @NotNull ShapedTagRecipeBuilder shaped(RecipeCategory category, @NotNull ItemLike result) {
    ...
    @Override
    public @NotNull ShapedTagRecipeBuilder unlockedBy(String criterionName, CriterionTriggerInstance criterionTrigger) {
