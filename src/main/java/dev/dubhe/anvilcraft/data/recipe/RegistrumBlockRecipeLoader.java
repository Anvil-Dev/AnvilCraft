...
public class RegistrumBlockRecipeLoader {
    ...
    public static <T extends Block> void neoforge(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.CAKE_BLOCK), AnvilCraftDatagen.has(lookup, ModBlocks.CAKE_BLOCK))
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModFoodItems.CREAMY_BREAD_ROLL),
                AnvilCraftDatagen.has(lookup, ModFoodItems.CREAMY_BREAD_ROLL)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void frostAnvil(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ).save(provider, AnvilCraft.recipe("smithing/frost_anvil"));
    }
    ...
    public static <T extends Block> void frostGrindstone(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SmithingTransformRecipeBuilder.smithing(
            ...
            AnvilCraftDatagen.hasItem(ModBlocks.FROST_METAL_BLOCK),
            AnvilCraftDatagen.has(lookup, ModBlocks.FROST_METAL_BLOCK)
        ).save(provider, AnvilCraft.recipe("smithing/frost_grindstone"));
    }
    ...
    public static <T extends Block> void frostSmithingTable(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SmithingTransformRecipeBuilder.smithing(
            ...
            AnvilCraftDatagen.hasItem(ModBlocks.FROST_METAL_BLOCK),
            AnvilCraftDatagen.has(lookup, ModBlocks.FROST_METAL_BLOCK)
        ).save(provider, AnvilCraft.recipe("smithing/frost_smithing_table"));
    }
        ...
        return (ctx, provider) -> {
            ...
            for (Item ingredient : ingredients) {
                ...
                ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get(), 1)
                    ...
                    .save(provider, AnvilCraft.recipe(id + "_from_" + location1.getPath().replace('/', '_')));
            }
        };
    }
        ...
        return (ctx, provider) -> {
            ...
            for (TagKey<Item> ingredient : ingredients) {
                ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get(), 1)
                    ...
                    .define('A', ingredient)
                    .unlockedBy(AnvilCraftDatagen.hasItem(ingredient), AnvilCraftDatagen.has(lookup, ingredient))
                    .save(provider, AnvilCraft.recipe(id + "_from_" + ingredient.location().getPath().replace('/', '_')));
            }
        };
    }
    ...
    public static <T extends Block> void ferriteCoreMagnetBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .unlockedBy("has_magnet_ingot", AnvilCraftDatagen.has(lookup, ModItems.MAGNET_INGOT))
            .unlockedBy("has_iron_ingot", AnvilCraftDatagen.has(lookup, Tags.Items.INGOTS_IRON))
            .save(provider);
    }
    ...
    public static <T extends Block> void stampingPlatform(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .define('B', Tags.Items.INGOTS_IRON)
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItemTags.IRON_PLATES), AnvilCraftDatagen.has(lookup, ModItemTags.IRON_PLATES))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Tags.Items.INGOTS_IRON))
            .save(provider);
    }
    ...
    public static <T extends Block> void crushingTable(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy("has_" + Items.GRINDSTONE, AnvilCraftDatagen.has(lookup, Items.GRINDSTONE))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Tags.Items.INGOTS_IRON))
            .save(provider, AnvilCraft.recipe("shapeless_crushing_table_recipe"));
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            .pattern("BAB")
            .pattern("B B")
            .pattern("B B")
            ...
            .unlockedBy("has_" + Items.GRINDSTONE, AnvilCraftDatagen.has(lookup, Items.GRINDSTONE))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Tags.Items.INGOTS_IRON))
            .save(provider, AnvilCraft.recipe("shaped_crushing_table_recipe"));
    }
    ...
    public static <T extends Block> void fluidTank(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.MISC, ctx.get(), 2)
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.FISH_TANK.asItem()), AnvilCraftDatagen.has(lookup, ModBlocks.FISH_TANK))
            .save(provider);
    }
    ...
    public static <T extends Block> void neutronIrradiator(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(
                ...
                AnvilCraftDatagen.has(lookup, ModItems.CHARGED_NEUTRONIUM_INGOT)
            )
            .unlockedBy(
    ...
    public static <T extends Block> void royalAnvil(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ).save(provider, AnvilCraft.recipe("smithing/royal_anvil"));
    }
    ...
    public static <T extends Block> void royalGrindstone(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SmithingTransformRecipeBuilder.smithing(
            ...
            AnvilCraftDatagen.hasItem(ModBlocks.ROYAL_STEEL_BLOCK),
            AnvilCraftDatagen.has(lookup, ModBlocks.ROYAL_STEEL_BLOCK)
        ).save(provider, AnvilCraft.recipe("smithing/royal_grindstone"));
    }
    ...
    public static <T extends Block> void royalSmithingTable(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SmithingTransformRecipeBuilder.smithing(
           ...
           AnvilCraftDatagen.hasItem(ModBlocks.ROYAL_STEEL_BLOCK),
           AnvilCraftDatagen.has(lookup, ModBlocks.ROYAL_STEEL_BLOCK)
       ).save(provider, AnvilCraft.recipe("smithing/royal_smithing_table"));
    }
    ...
    public static <T extends Block> void emberAnvil(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ).save(provider, AnvilCraft.recipe("smithing/ember_anvil"));
    }
    ...
    public static <T extends Block> void emberGrindstone(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SmithingTransformRecipeBuilder.smithing(
            ...
            AnvilCraftDatagen.hasItem(ModBlocks.EMBER_METAL_BLOCK),
            AnvilCraftDatagen.has(lookup, ModBlocks.EMBER_METAL_BLOCK)
        ).save(provider, AnvilCraft.recipe("smithing/ember_grindstone"));
    }
    ...
    public static <T extends Block> void heater(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.TERRACOTTA), AnvilCraftDatagen.has(lookup, Items.TERRACOTTA))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Items.IRON_INGOT))
            .unlockedBy(
    ...
    public static <T extends Block> void remoteTransmissionPole(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.TRANSMISSION_POLE), AnvilCraftDatagen.has(lookup, ModBlocks.TRANSMISSION_POLE))
            .save(provider);
    }
    ...
    public static <T extends Block> void teslaTower(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.TRANSMISSION_POLE), AnvilCraftDatagen.has(lookup, ModBlocks.TRANSMISSION_POLE))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.TOPAZ_BLOCK), AnvilCraftDatagen.has(lookup, ModBlocks.TOPAZ_BLOCK))
            .save(provider);
    }
    ...
    public static <T extends Block> void heliostats(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 8)
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.SUNFLOWER), AnvilCraftDatagen.has(lookup, Items.SUNFLOWER))
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.IRON_BLOCK), AnvilCraftDatagen.has(lookup, Blocks.IRON_BLOCK))
            .save(provider, AnvilCraft.recipe("heliostats_biological"));
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 8)
            .pattern("SDS")
            .pattern("SCS")
            .pattern(" I ")
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.IRON_BLOCK), AnvilCraftDatagen.has(lookup, Blocks.IRON_BLOCK))
            .save(provider, AnvilCraft.recipe("heliostats_electrical"));
    }
    ...
    public static <T extends Block> void loadMonitor(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 4)
            ...
            .define('B', ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK)
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.COMPASS), AnvilCraftDatagen.has(lookup, Items.COMPASS))
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK),
                AnvilCraftDatagen.has(lookup, ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK)
            )
    ...
    public static <T extends Block> void piezoelectricCrystal(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 4)
            ...
            .group(ctx.getId().toString())
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.COPPER_INGOT), AnvilCraftDatagen.has(lookup, Items.COPPER_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.QUARTZ_BLOCK), AnvilCraftDatagen.has(lookup, Items.QUARTZ_BLOCK))
            .save(provider);
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 4)
            .pattern("ABA")
            .pattern(" B ")
            ...
            .group(ctx.getId().toString())
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.COPPER_INGOT), AnvilCraftDatagen.has(lookup, Items.COPPER_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.AMETHYST_BLOCK), AnvilCraftDatagen.has(lookup, Items.AMETHYST_BLOCK))
    ...
    public static <T extends Block> void batchCrafter(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.GLASS), AnvilCraftDatagen.has(lookup, Items.GLASS))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.CRAFTER), AnvilCraftDatagen.has(lookup, Items.CRAFTER))
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK),
                AnvilCraftDatagen.has(lookup, ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK)
            )
    ...
    public static <T extends Block> void batchCutter(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .define('E', ModItems.CIRCUIT_BOARD)
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.GLASS), AnvilCraftDatagen.has(lookup, Items.GLASS))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.STONECUTTER), AnvilCraftDatagen.has(lookup, Items.STONECUTTER))
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK),
                AnvilCraftDatagen.has(lookup, ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK)
            )
    ...
    public static <T extends Block> void itemCollector(DataGenContext<Block, T> c, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, c.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Items.IRON_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.MAGNET), AnvilCraftDatagen.has(lookup, ModItems.MAGNET))
    ...
    public static <T extends Block> void heatCollector(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.SAPPHIRE), AnvilCraftDatagen.has(lookup, ModItems.SAPPHIRE))
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.BLUE_ICE), AnvilCraftDatagen.has(lookup, Items.BLUE_ICE))
    ...
    public static <T extends Block> void charger(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModBlocks.DISCHARGER))
            .save(provider, AnvilCraft.recipe("charger_from_discharger"));
    }
    ...
    public static <T extends Block> void discharger(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .save(provider, AnvilCraft.recipe("discharger_from_charger"));
    }
    ...
    public static <T extends Block> void activeSilencer(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.AMETHYST_BLOCK), AnvilCraftDatagen.has(lookup, Items.AMETHYST_BLOCK))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.NOTE_BLOCK), AnvilCraftDatagen.has(lookup, Items.NOTE_BLOCK))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.SCULK_SENSOR), AnvilCraftDatagen.has(lookup, Items.SCULK_SENSOR))
            .save(provider, AnvilCraft.recipe("active_silencer_old"));
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            .pattern("ABA")
            .pattern("ACA")
            .pattern("BDB")
            ...
            .unlockedBy(
                ...
                AnvilCraftDatagen.has(lookup, ModBlocks.PIEZOELECTRIC_CRYSTAL)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void blockDevourer(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.NETHERITE_INGOT), AnvilCraftDatagen.has(lookup, Items.NETHERITE_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.DRAGON_HEAD), AnvilCraftDatagen.has(lookup, Items.DRAGON_HEAD))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.REDSTONE), AnvilCraftDatagen.has(lookup, Items.REDSTONE))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.COBBLESTONE), AnvilCraftDatagen.has(lookup, Items.COBBLESTONE))
            .save(provider);
    }
    ...
    public static <T extends Block> void rubyLaser(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 4)
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.ROYAL_STEEL_INGOT), AnvilCraftDatagen.has(lookup, ModItems.ROYAL_STEEL_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.INDUCTION_LIGHT), AnvilCraftDatagen.has(lookup, ModBlocks.INDUCTION_LIGHT))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItemTags.SILVER_PLATES), AnvilCraftDatagen.has(lookup, ModItemTags.SILVER_PLATES))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.RUBY_BLOCK), AnvilCraftDatagen.has(lookup, ModBlocks.RUBY_BLOCK))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.TINTED_GLASS), AnvilCraftDatagen.has(lookup, Items.TINTED_GLASS))
            .save(provider);
    }
    ...
    public static <T extends Block> void rubyPrism(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.ROYAL_STEEL_INGOT), AnvilCraftDatagen.has(lookup, ModItems.ROYAL_STEEL_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.RUBY_BLOCK), AnvilCraftDatagen.has(lookup, ModBlocks.RUBY_BLOCK))
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RUBY), AnvilCraftDatagen.has(lookup, ModItems.RUBY))
            .save(provider);
    }
    ...
    public static <T extends Block> void lens(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.ROYAL_STEEL_INGOT))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, Items.GLASS))
            .save(provider);
    }
    ...
    public static <T extends Block> void laserReceiver(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModBlocks.MAGNETO_ELECTRIC_CORE_BLOCK))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, Items.REDSTONE))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.ROYAL_STEEL_INGOT))
            .save(provider);
    }
    ...
    public static <T extends Block> void impactPile(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.OBSIDIAN), AnvilCraftDatagen.has(lookup, Blocks.OBSIDIAN))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.NETHERITE_INGOT), AnvilCraftDatagen.has(lookup, Items.NETHERITE_INGOT))
            .save(provider);
    }
    ...
    public static <T extends Block> void jewelCraftingTable(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.GRINDSTONE), AnvilCraftDatagen.has(lookup, Blocks.GRINDSTONE))
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.STONECUTTER), AnvilCraftDatagen.has(lookup, Blocks.STONECUTTER))
            .save(provider);
    }
    ...
    public static <T extends Block> void crabTrap(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.STRING), AnvilCraftDatagen.has(lookup, Items.STRING))
            .save(provider);
    }
    ...
    public static <T extends Block> void chute(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get(), 4)
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.IRON_INGOT), AnvilCraftDatagen.has(lookup, Items.IRON_INGOT))
            .unlockedBy(AnvilCraftDatagen.hasItem(Items.DROPPER), AnvilCraftDatagen.has(lookup, Items.DROPPER))
            .save(provider);
    }
    ...
    public static <T extends Block> void slidingRail(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get(), 16)
            ...
            .define('B', Items.IRON_INGOT)
            .unlockedBy(AnvilCraftDatagen.hasItem(Blocks.BLUE_ICE), AnvilCraftDatagen.has(lookup, Blocks.BLUE_ICE))
            .save(provider);
    }
    ...
    public static <T extends Block> void poweredSlidingRail(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get(), 8)
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.SLIDING_RAIL), AnvilCraftDatagen.has(lookup, ModBlocks.SLIDING_RAIL))
            .save(provider);
    }
    ...
    public static <T extends Block> void voidEnergyCollector(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.MISC, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModBlocks.CHARGE_COLLECTOR), AnvilCraftDatagen.has(lookup, ModBlocks.CHARGE_COLLECTOR))
    ...
    public static <T extends Block> void propelPiston(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(
            ...
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.IONOCRAFT))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.CAPACITOR))
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.REDSTONE, ctx.get())
            ...
            .define('E', ModItems.RUBY)
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.IONOCRAFT))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.CAPACITOR_EMPTY))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, Items.IRON_INGOT))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, Items.PISTON))
            .unlockedBy("has_item", AnvilCraftDatagen.has(lookup, ModItems.RUBY))
    ...
    public static <T extends Block> void cutEmberMetalSlab(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        stonecutting(Ingredient.of(ModBlocks.CUT_EMBER_METAL_BLOCK), ctx.get(), 2)
            ...
            .save(provider, AnvilCraft.recipe("stonecutting/cut_ember_metal_slab_from_cut_ember_metal_block"));
    }
    ...
    public static <T extends Block> void cutEmberMetalStairs(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        stonecutting(Ingredient.of(ModBlocks.CUT_EMBER_METAL_BLOCK), ctx.get())
            ...
            .save(provider, AnvilCraft.recipe("stonecutting/cut_ember_metal_stairs_from_cut_ember_metal_block"));
    }
    ...
    public static <T extends Block> void heavyIronBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(
                AnvilCraftDatagen.hasItem(Tags.Items.STORAGE_BLOCKS_IRON),
                AnvilCraftDatagen.has(lookup, Tags.Items.STORAGE_BLOCKS_IRON)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void cutHeavyIronSlab(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        stonecutting(Ingredient.of(ModBlocks.CUT_HEAVY_IRON_BLOCK), ctx.get(), 2)
            ...
            .save(provider, AnvilCraft.recipe("stonecutting/" + ctx.getName() + "_from_cut_heavy_iron_block"));
    }
    ...
    public static <T extends Block> void heavyIronPlate(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        SingleItemRecipeBuilder.stonecutting(
            ...
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModBlocks.POLISHED_HEAVY_IRON_SLAB),
        ...
        stonecutting(Ingredient.of(ModBlocks.CUT_HEAVY_IRON_SLAB), ctx.get())
            ...
            .save(provider, AnvilCraft.recipe("stonecutting/" + ctx.getName() + "_from_cut_heavy_iron_slab"));
    }
    ...
    public static <T extends Block> void titaniumBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItemTags.TITANIUM_INGOTS), AnvilCraftDatagen.has(lookup, ModItemTags.TITANIUM_INGOTS))
            .save(provider);
    }
    ...
    public static <T extends Block> void tungstenBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItemTags.TUNGSTEN_INGOTS), AnvilCraftDatagen.has(lookup, ModItemTags.TUNGSTEN_INGOTS))
            .save(provider);
    }
    ...
    public static <T extends Block> void topazBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.TOPAZ), AnvilCraftDatagen.has(lookup, ModItems.TOPAZ))
            .save(provider);
    }
    ...
    public static <T extends Block> void amberBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.AMBER), AnvilCraftDatagen.has(lookup, ModItems.AMBER))
            .save(provider);
    }
    ...
    public static <T extends Item> void levitationPowderBlock(DataGenContext<Item, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.DECORATIONS, ctx.get())
            ...
            .save(provider, ctx.getId().withSuffix("_from_powders").toString());
    }
    ...
    public static <T extends Block> void chocolateBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModFoodItems.CHOCOLATE), AnvilCraftDatagen.has(lookup, ModFoodItems.CHOCOLATE))
            .save(provider);
    }
    ...
    public static <T extends Block> void blackChocolateBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModFoodItems.CHOCOLATE_BLACK),
                AnvilCraftDatagen.has(lookup, ModFoodItems.CHOCOLATE_BLACK)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void whiteChocolateBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(
                AnvilCraftDatagen.hasItem(ModFoodItems.CHOCOLATE_WHITE),
                AnvilCraftDatagen.has(lookup, ModFoodItems.CHOCOLATE_WHITE)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void rawZincBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_ZINC), AnvilCraftDatagen.has(lookup, ModItems.RAW_ZINC))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawTinBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_TIN), AnvilCraftDatagen.has(lookup, ModItems.RAW_TIN))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawTitaniumBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_TITANIUM), AnvilCraftDatagen.has(lookup, ModItems.RAW_TITANIUM))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawTungstenBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_TUNGSTEN), AnvilCraftDatagen.has(lookup, ModItems.RAW_TUNGSTEN))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawLeadBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_LEAD), AnvilCraftDatagen.has(lookup, ModItems.RAW_LEAD))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawSilverBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_SILVER), AnvilCraftDatagen.has(lookup, ModItems.RAW_SILVER))
            .save(provider);
    }
    ...
    public static <T extends Block> void rawUraniumBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(AnvilCraftDatagen.hasItem(ModItems.RAW_URANIUM), AnvilCraftDatagen.has(lookup, ModItems.RAW_URANIUM))
            .save(provider);
    }
    ...
    public static <T extends Block> void excitedStateVoidMatterBlock(
        ...
        ShapedRecipeBuilder.shaped(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .unlockedBy(
                ...
                AnvilCraftDatagen.has(lookup, ModItems.EXCITED_STATE_VOID_MATTER)
            )
            .save(provider);
    }
    ...
    public static <T extends Block> void sugarBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, Items.SUGAR, 9)
            .requires(ctx.get())
            .unlockedBy(AnvilCraftDatagen.hasItem(ctx.get()), AnvilCraftDatagen.has(lookup, ctx.get()))
            .save(provider, AnvilCraft.recipe("sugar_from_sugar_block"));
    }
    ...
    public static <T extends Block> void gunpowerBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .save(provider);
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, Items.GUNPOWDER, 9)
            .requires(ctx.get())
            .unlockedBy(AnvilCraftDatagen.hasItem(ctx.get()), AnvilCraftDatagen.has(lookup, ctx.get()))
            .save(provider, AnvilCraft.recipe("gunpowder_from_gunpowder_block"));
    }
    ...
    public static <T extends Block> void rottenFleshBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .save(provider);
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, Items.ROTTEN_FLESH, 9)
            .requires(ctx.get())
            .unlockedBy(AnvilCraftDatagen.hasItem(ctx.get()), AnvilCraftDatagen.has(lookup, ctx.get()))
            .save(provider, AnvilCraft.recipe("rotten_flesh_from_rotten_flesh_block"));
        SimpleCookingRecipeBuilder.smelting(
            Ingredient.of(ctx.get()),
            RecipeCategory.MISC,
    ...
    public static <T extends Block> void flintBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, ctx.get())
            ...
            .save(provider);
        ShapelessRecipeBuilder.shapeless(lookup, RecipeCategory.BUILDING_BLOCKS, Items.FLINT, 9)
            .requires(ctx.get())
            .unlockedBy(AnvilCraftDatagen.hasItem(ctx.get()), AnvilCraftDatagen.has(lookup, ctx.get()))
            .save(provider, AnvilCraft.recipe("flint_from_flint_block"));
    }
    ...
    public static <T extends Block> void cutFlintBlock(DataGenContext<Block, T> ctx, RegistrumRecipeProvider provider) {
        ...
        stonecutting(Ingredient.of(ModBlocks.POLISHED_FLINT_BLOCK.get()), ctx.get())
            ...
            .save(provider, AnvilCraft.recipe("stonecutting/cut_flint_block_from_polished_flint_block"));
    }
    ...
    private static SingleItemRecipeBuilder stonecutting(Ingredient ingredient, ItemLike result, int count) {
        return RegistrumBlockRecipeLoader.stonecutting(ingredient, RecipeCategory.BUILDING_BLOCKS, result, count);
    }
