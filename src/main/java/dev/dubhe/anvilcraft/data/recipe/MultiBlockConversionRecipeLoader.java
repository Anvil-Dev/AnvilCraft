...
public class MultiBlockConversionRecipeLoader {
    public static void init(RegistrateRecipeProvider provider) {
        ...
        MultiblockConversionRecipe.builder()
            ...
            .outputLayer("JKL", "MNO", "PQR")
            .outputLayer("STU", "VWX", "YZ[")
            .outputSymbol('A', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_wn")
                .hasState("opened", "false")
            )
            .outputSymbol('B', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_n")
                .hasState("opened", "false")
            )
            .outputSymbol('C', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_en")
                .hasState("opened", "false")
            )
            .outputSymbol('D', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_w")
                .hasState("opened", "false")
            )
            .outputSymbol('E', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_center")
                .hasState("opened", "false")
            )
            .outputSymbol('F', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_e")
                .hasState("opened", "false")
            )
            .outputSymbol('G', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_ws")
                .hasState("opened", "false")
            )
            .outputSymbol('H', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_s")
                .hasState("opened", "false")
            )
            .outputSymbol('I', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "bottom_es")
                .hasState("opened", "false")
            )
            .outputSymbol('J', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_wn")
                .hasState("opened", "false")
            )
            .outputSymbol('K', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_n")
                .hasState("opened", "false")
            )
            .outputSymbol('L', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_en")
                .hasState("opened", "false")
            )
            .outputSymbol('M', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_w")
                .hasState("opened", "false")
            )
            .outputSymbol('N', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_center")
                .hasState("opened", "false")
            )
            .outputSymbol('O', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_e")
                .hasState("opened", "false")
            )
            .outputSymbol('P', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_ws")
                .hasState("opened", "false")
            )
            .outputSymbol('Q', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_s")
                .hasState("opened", "false")
            )
            .outputSymbol('R', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "mid_es")
                .hasState("opened", "false")
            )
            .outputSymbol('S', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_wn")
                .hasState("opened", "false")
            )
            .outputSymbol('T', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_n")
                .hasState("opened", "false")
            )
            .outputSymbol('U', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_en")
                .hasState("opened", "false")
            )
            .outputSymbol('V', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_w")
                .hasState("opened", "false")
            )
            .outputSymbol('W', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_center")
                .hasState("opened", "false")
            )
            .outputSymbol('X', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_e")
                .hasState("opened", "false")
            )
            .outputSymbol('Y', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_ws")
                .hasState("opened", "false")
            )
            .outputSymbol('Z', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_s")
                .hasState("opened", "false")
            )
            .outputSymbol('[', BlockPredicateWithState.of(ModBlocks.SHULKER_CRATE)
                .hasState("half", "top_es")
                .hasState("opened", "false")
            )
            .save(provider, AnvilCraft.of("multiblock_conversion/shulker_crate"));
    }
}
