...
public class MultiBlockConversionRecipeLoader {
    public static void init(RegistrumRecipeProvider provider) {
        ...
        MultiblockConversionRecipe.builder()
            ...
            .inputLayer("B  ", "C  ", "DEF")
            .inputLayer("G  ", "G  ", "HHH")
            .inputSymbol('A', "minecraft:smooth_stone")
            .inputSymbol('B', BlockPredicateWithState.of("minecraft:stonecutter")
                .hasState("facing", "east")
            )
            .inputSymbol('C', BlockPredicateWithState.of("anvilcraft:jewelcrafting_table")
                .hasState("facing", "east")
            )
            .inputSymbol('D', "minecraft:cartography_table")
            .inputSymbol('E', "minecraft:crafting_table")
            .inputSymbol('F', BlockPredicateWithState.of("minecraft:loom")
                .hasState("facing", "north")
            )
            .inputSymbol('G', BlockPredicateWithState.of("minecraft:spruce_trapdoor")
                .hasState("half", "bottom")
                .hasState("open", "true")
                .hasState("facing", "east")
                .hasState("waterlogged", "false")
            )
            .inputSymbol('H', BlockPredicateWithState.of("minecraft:spruce_trapdoor")
                .hasState("half", "bottom")
                .hasState("open", "true")
                .hasState("facing", "north")
                .hasState("waterlogged", "false")
            ...
            .outputLayer("JKL", "MNO", "PQR")
            .outputLayer("STU", "VWX", "YZ[")
            .outputSymbol('A', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_WN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('B', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_N)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('C', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_EN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('D', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_W)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('E', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_CENTER)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('F', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_E)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('G', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_WS)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('H', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_S)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('I', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.BOTTOM_ES)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('J', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_WN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('K', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_N)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('L', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_EN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('M', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_W)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('N', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_CENTER)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CENTER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('O', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_E)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('P', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_WS)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('Q', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_S)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('R', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.MID_ES)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('S', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_WN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('T', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_N)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('U', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_EN)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('V', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_W)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('W', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_CENTER)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('X', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_E)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('Y', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_WS)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('Z', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_S)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .outputSymbol('[', BlockPredicateWithState.of(ModBlocks.WORKSHOP)
                .hasState(WorkshopBlock.PART, Cube3x3PartHalf.TOP_ES)
                .hasState(WorkshopBlock.CUBE, WorkshopCube.CORNER)
                .hasState(WorkshopBlock.FACING, Direction.NORTH)
            )
            .save(provider, AnvilCraft.of("multiblock_conversion/workshop"));
    }
}
