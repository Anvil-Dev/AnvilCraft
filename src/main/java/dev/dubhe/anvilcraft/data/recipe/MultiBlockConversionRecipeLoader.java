...
public class MultiBlockConversionRecipeLoader {
    public static void init(RegistrumRecipeProvider provider) {
        ...
        MultiblockConversionRecipe.builder()
            ...
            .inputSymbol('F', BlockPredicateWithState.of("anvilcraft:ruby_prism")
                .hasState("facing", "east")
            )
            .inputSymbol('G', BlockPredicateWithState.of("anvilcraft:ruby_prism")
                .hasState("facing", "west")
            )
            .inputSymbol('H', BlockPredicateWithState.of("anvilcraft:ruby_prism")
                .hasState("facing", "south")
            )
            .inputSymbol('I', BlockPredicateWithState.of("anvilcraft:ruby_prism")
                .hasState("facing", "north")
            )
            .outputLayer("ABC", "DEF", "GHI")
            .outputLayer("JKL", "MNO", "PQR")
            .outputLayer("STU", "VWX", "YZ[")
            .outputSymbol('A', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_wn")
                .hasState("switch", "on")
            )
            .outputSymbol('B', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_n")
                .hasState("switch", "on")
            )
            .outputSymbol('C', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_en")
                .hasState("switch", "on")
            )
            .outputSymbol('D', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_w")
                .hasState("switch", "on")
            )
            .outputSymbol('E', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_center")
                .hasState("switch", "on")
            )
            .outputSymbol('F', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_e")
                .hasState("switch", "on")
            )
            .outputSymbol('G', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_ws")
                .hasState("switch", "on")
            )
            .outputSymbol('H', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_s")
                .hasState("switch", "on")
            )
            .outputSymbol('I', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "bottom_es")
                .hasState("switch", "on")
            )
            .outputSymbol('J', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_wn")
                .hasState("switch", "on")
            )
            .outputSymbol('K', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_n")
                .hasState("switch", "on")
            )
            .outputSymbol('L', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_en")
                .hasState("switch", "on")
            )
            .outputSymbol('M', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_w")
                .hasState("switch", "on")
            )
            .outputSymbol('N', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_center")
                .hasState("switch", "on")
            )
            .outputSymbol('O', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_e")
                .hasState("switch", "on")
            )
            .outputSymbol('P', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_ws")
                .hasState("switch", "on")
            )
            .outputSymbol('Q', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_s")
                .hasState("switch", "on")
            )
            .outputSymbol('R', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "mid_es")
                .hasState("switch", "on")
            )
            .outputSymbol('S', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_wn")
                .hasState("switch", "on")
            )
            .outputSymbol('T', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_n")
                .hasState("switch", "on")
            )
            .outputSymbol('U', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_en")
                .hasState("switch", "on")
            )
            .outputSymbol('V', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_w")
                .hasState("switch", "on")
            )
            .outputSymbol('W', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_center")
                .hasState("switch", "on")
            )
            .outputSymbol('X', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_e")
                .hasState("switch", "on")
            )
            .outputSymbol('Y', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_ws")
                .hasState("switch", "on")
            )
            .outputSymbol('Z', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_s")
                .hasState("switch", "on")
            )
            .outputSymbol('[', BlockPredicateWithState.of("anvilcraft:large_laser")
                .hasState("overload", "true")
                .hasState("facing", "down")
                .hasState("half", "top_es")
                .hasState("switch", "on")
