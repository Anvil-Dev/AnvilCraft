    ...
    private static void createOverworldLike(RegistrumRecipeProvider provider) {
        SpecialCelestialBodyRecipeLoader.saveRecipe(
            provider, "overworld_like", new SpecialCelestialBodyRecipe(
                ...
                20,
                16,
                Optional.of(new ColorRGBA(0x99CCFF)),
                Optional.of(LiquidCoverage.MEDIUM),
                2,
                2,
                0f,
                List.of(
                    SpecialCelestialBodyRecipeLoader.mc("grass_block")
                ),
                List.of(
                ...
                List.of(
                    ...
                    SpecialCelestialBodyRecipeLoader.item("minecraft:white_wool", 9),
                    SpecialCelestialBodyRecipeLoader.item("minecraft:light_gray_wool", 3),
                    SpecialCelestialBodyRecipeLoader.item("minecraft:gray_wool", 3),
                    SpecialCelestialBodyRecipeLoader.item("minecraft:black_wool", 3),
                    SpecialCelestialBodyRecipeLoader.item("minecraft:brown_wool", 3),
                ...
                List.of(SpecialCelestialBodyRecipeLoader.item("minecraft:milk", 50)),
                List.of(),
                List.of(),
                List.of(),
    ...
    private static void createFleshPlanet(RegistrumRecipeProvider provider) {
        SpecialCelestialBodyRecipeLoader.saveRecipe(
            provider, "flesh_planet", new SpecialCelestialBodyRecipe(
                ...
                9,
                17,
                Optional.of(new ColorRGBA(0xE6804D)),
                Optional.of(LiquidCoverage.NONE),
                2,
                2,
                22f,
    ...
    private static void createIntelligentPlanet(RegistrumRecipeProvider provider) {
        SpecialCelestialBodyRecipeLoader.saveRecipe(
            provider, "intelligent_planet", new SpecialCelestialBodyRecipe(
                ...
                List.of(),
                List.of(SpecialCelestialBodyRecipeLoader.item("anvilcraft:exp_fluid", 100)),
                List.of(),
                List.of(),
                List.of(),
                List.of(),
