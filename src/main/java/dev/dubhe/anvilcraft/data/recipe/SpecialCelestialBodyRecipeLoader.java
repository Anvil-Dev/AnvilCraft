...
public class SpecialCelestialBodyRecipeLoader {
    ...
    private static void createOverworldLike(RegistrumRecipeProvider provider) {
        saveRecipe(provider, "overworld_like", new SpecialCelestialBodyRecipe(
            ...
            List.of(item("minecraft:porkchop", 5), item("minecraft:beef", 5), item("minecraft:mutton", 5),
                item("minecraft:chicken", 5), item("minecraft:leather", 5), item("minecraft:feather", 5),
                item("minecraft:white_wool", 10), item("minecraft:light_gray_wool", 4),
                item("minecraft:gray_wool", 4), item("minecraft:black_wool", 4),
                item("minecraft:brown_wool", 4), item("minecraft:red_wool", 2),
                item("minecraft:orange_wool", 2), item("minecraft:yellow_wool", 2),
                item("minecraft:lime_wool", 2), item("minecraft:green_wool", 2),
                item("minecraft:cyan_wool", 2), item("minecraft:light_blue_wool", 2),
                item("minecraft:blue_wool", 2), item("minecraft:purple_wool", 2),
                item("minecraft:magenta_wool", 2), item("minecraft:pink_wool", 2)),
    ...
    private static void createIntelligentPlanet(RegistrumRecipeProvider provider) {
        saveRecipe(provider, "intelligent_planet", new SpecialCelestialBodyRecipe(
    ...
    private static void createHollowPlanet(RegistrumRecipeProvider provider) {
        saveRecipe(provider, "hollow_planet", new SpecialCelestialBodyRecipe(
