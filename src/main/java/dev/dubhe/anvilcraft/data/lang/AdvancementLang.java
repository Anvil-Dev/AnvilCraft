...
public class AdvancementLang {
    ...
    public static void init(RegistrumLangProvider provider) {
        ...
        provider.add("advancements.anvilcraft.salted_fish_turns_over.description", "Use an Anvil Hammer to turn a Block Comparator from a horizontal position to an upright position");
        // endregion
