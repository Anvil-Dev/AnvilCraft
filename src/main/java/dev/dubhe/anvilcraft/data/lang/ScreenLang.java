...
public class ScreenLang {
    ...
    public static void init(RegistrumLangProvider provider) {
        ...
        // Seed slot tooltip
        provider.add("screen.anvilcraft.cfa.seed_slot.line1", "Consume all items placed in."); // 消耗所有放入的物品
        provider.add("screen.anvilcraft.cfa.seed_slot.line2", "If specific item has been consumed, a hidden celestial body will be discovered."); // 若消耗特定物品，将搜索到隐秘的天体
