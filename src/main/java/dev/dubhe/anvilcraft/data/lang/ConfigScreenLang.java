...
public class ConfigScreenLang {
    ...
    private static void addOverrides(RegistrumLangProvider provider) {
        ...
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud", "Ionocraft Backpack HUD");
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.button", "Expand Submenu");
        addOverride(
            provider,
        ...
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.enabled", "Enable Ionocraft Backpack HUD");
        addOverride(
            provider,
        ...
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.hud_scale", "HUD Scale");
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.hud_scale.tooltip", "HUD scale multiplier");
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.hud_x", "HUD X Coordinate");
        addOverride(
            provider,
        ...
        addOverride(provider, "anvilcraft.configuration.iono_craft_backpack_hud.hud_y", "HUD Y Coordinate");
        addOverride(
            provider,
