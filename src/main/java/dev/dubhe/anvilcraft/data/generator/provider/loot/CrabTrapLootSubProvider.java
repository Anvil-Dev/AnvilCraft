...
public class CrabTrapLootSubProvider implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_COMMON, LootTable.lootTable().withPool(
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_RIVER, LootTable.lootTable().withPool(
                LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_OCEAN, LootTable.lootTable().withPool(
                LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_WARM_OCEAN, LootTable.lootTable().withPool(
                LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_SWAMP, LootTable.lootTable().withPool(
                LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
        ...
        consumer.accept(ModLootTables.CRAB_TRAP_JUNGLE, LootTable.lootTable().withPool(
                LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f))
