...
public class BlockTagLoader {
    ...
    public static void init(RegistrumTagsProvider<Block> provider) {
        ...
        provider.addTag(ModBlockTags.ANVIL_HAMMER_BLACKLIST)
            ...
            .add(ModBlocks.CELESTIAL_FORGING_ANVIL_LOGISTICS_INTERFACE.getKey())
            .add(ModBlocks.CELESTIAL_FORGING_ANVIL_FLUID_INTERFACE.getKey())
            .add(ModBlocks.CELESTIAL_FORGING_ANVIL_LASER_INTERFACE.getKey())
