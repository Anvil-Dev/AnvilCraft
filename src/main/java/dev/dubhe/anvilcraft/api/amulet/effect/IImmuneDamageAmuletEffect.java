...
public interface IImmuneDamageAmuletEffect extends IAmuletEffect {
    @Override
    default void trigger(LivingEntity entity, ItemStack amulet, AmuletEffectContext ctx) {
    ...
    boolean shouldImmune(LivingEntity entity, ItemStack amulet, DamageSource source, AmuletEffectContext ctx);
}
