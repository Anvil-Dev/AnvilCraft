...
public class DischargerTooltipProvider extends ITooltipProvider.BlockEntityTooltipProvider {
    ...
    public List<Component> tooltip(BlockEntity value) {
        ...
        if (discharger.getBlockState().hasProperty(IPowerComponent.OVERLOAD)) {
            overloaded = discharger.getBlockState().getValueOrElse(IPowerComponent.OVERLOAD, true).equals(Boolean.TRUE);
        }
        ...
        double progress = discharger.getProgress();
