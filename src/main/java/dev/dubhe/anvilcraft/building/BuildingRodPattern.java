...
final class BuildingRodPattern {
    ...
    @Nullable
    static List<BuildingRodService.Group> plan(Player player, ItemStack filter, BlockPos first, BlockPos last,
        ...
        List<BuildingRodService.Group> groups = new ArrayList<>();
        ...
        for (BlockPos cursor : BlockPos.betweenClosed(first, last)) {
            ...
            List<BuildingRodService.Group> planned = BuildingRodService.planBlocks(player, material, pos, pos, face, null);
