...
public class ModItemGroups {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ANVILCRAFT_TOOL = DF.register("tools", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ANVILCRAFT_INGREDIENTS = DF.register("ingredients", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ANVILCRAFT_FUNCTION_BLOCK = DF.register("functional_block", () -> CreativeModeTab.builder()
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ANVILCRAFT_BUILD_BLOCK = DF.register("building_block", () -> CreativeModeTab.builder()
