...
public class ModEntityTypeTags {
    public static final TagKey<EntityType<?>> AMULET_VALID = ModEntityTypeTags.bind("amulet_valid");
    ...
    public static final TagKey<EntityType<?>> FALLING_GIANT_ANVIL_DAMAGE_IMMUNE = ModEntityTypeTags.bind(
        "falling_giant_anvil_damage_immune"
    );
