...
public class ModRegistries {
    public static final ResourceKey<Registry<IAmulet.Type<?>>> AMULET_TYPE_KEY = ResourceKey.createRegistryKey(
        AnvilCraft.of("amulet_type")
    );
    public static final Registry<IAmulet.Type<?>> AMULET_TYPE_REGISTRY = new RegistryBuilder<>(AMULET_TYPE_KEY)
        .sync(true)
        .maxId(512)
        .create();
    public static final ResourceKey<Registry<IAmuletDefinition.Type<?>>> AMULET_DEF_TYPE_KEY = ResourceKey.createRegistryKey(
        AnvilCraft.of("amulet_definition_type")
    );
    public static final Registry<IAmuletDefinition.Type<?>> AMULET_DEF_TYPE_REGISTRY = new RegistryBuilder<>(AMULET_DEF_TYPE_KEY)
        .sync(true)
        .maxId(512)
        .create();
    public static final ResourceKey<Registry<IAmuletDefinition>> AMULET_DEF = ResourceKey.createRegistryKey(
        AnvilCraft.of("amulet_definition")
    );
    ...
    public static void registerRegistries(DataPackRegistryEvent.NewRegistry event) {
        event.dataPackRegistry(ModRegistries.AMULET_DEF, IAmuletDefinition.DIRECT_CODEC, IAmuletDefinition.DIRECT_CODEC);
    }
}
