...
public class ToolsAndUtilities extends DisplayItemsGenerator {
    ...
    public void accept() {
        ...
        this.plain(ModItems.CREAM); // 奶油
        this.plain(ModItems.FLOUR); // 面粉
        this.plain(ModItems.DOUGH); // 面团
        this.plain(ModItems.COCOA_LIQUOR); // 可可液块
        this.plain(ModItems.COCOA_BUTTER); // 可可脂
        this.plain(ModItems.COCOA_POWDER); // 可可粉
