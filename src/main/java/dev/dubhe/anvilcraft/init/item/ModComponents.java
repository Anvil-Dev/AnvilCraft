...
public class ModComponents {
    ...
    public static final DataComponentType<CraftingStorage> CRAFTING = register(
        "crafting",
        b -> b.persistent(CraftingStorage.CODEC.codec()).networkSynchronized(CraftingStorage.STREAM_CODEC)
    );
