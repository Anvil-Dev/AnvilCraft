...
public class ModSoundEvents {
    ...
    public static final Supplier<SoundEvent> BURNING_HEATER = ModSoundEvents.REGISTER.register(
        "burning_heater", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("burning_heater"))
    );

    public static final Supplier<SoundEvent> PLASMA_JET_LAVA = ModSoundEvents.REGISTER.register(
        "plasma_jet_lava", () -> SoundEvent.createFixedRangeEvent(AnvilCraft.of("plasma_jet_lava"), 12.0f)
    );

    public static final Supplier<SoundEvent> GIANT_ANVIL_LAND = ModSoundEvents.REGISTER.register(
        "giant_anvil_land", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("giant_anvil_land"))
    );

    public static final Supplier<SoundEvent> GIANT_ANVIL_SHOCK = ModSoundEvents.REGISTER.register(
        "giant_anvil_shock", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("giant_anvil_shock"))
    );

    public static final Supplier<SoundEvent> GIANT_ANVIL_RESIN_SHOCK = ModSoundEvents.REGISTER.register(
        "giant_anvil_resin_shock", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("giant_anvil_resin_shock"))
    );

    public static final Supplier<SoundEvent> NEOFORGE_LAND = ModSoundEvents.REGISTER.register(
        "neoforge_land", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("neoforge_land"))
    );

    public static final Supplier<SoundEvent> TESLA_TOWER_STRIKE = ModSoundEvents.REGISTER.register(
        "tesla_tower_strike", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("tesla_tower_strike"))
    );

    public static final Supplier<SoundEvent> SMART_BLOCK_PLACER_EXTEND = ModSoundEvents.REGISTER.register(
        "smart_block_placer_extend", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("smart_block_placer_extend"))
    );
    public static final Supplier<SoundEvent> SMART_BLOCK_PLACER_RETRACT = ModSoundEvents.REGISTER.register(
        "smart_block_placer_retract", () -> SoundEvent.createVariableRangeEvent(AnvilCraft.of("smart_block_placer_retract"))
    );

    public static final Supplier<SoundEvent> SMART_BLOCK_PLACER_SHULKER_OPEN = ModSoundEvents.REGISTER.register(
