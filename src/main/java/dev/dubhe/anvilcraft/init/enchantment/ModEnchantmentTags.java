...
public class ModEnchantmentTags {
    public static final TagKey<Enchantment> DISABLED_PASSED = ModEnchantmentTags.bind("disabled_passed");
    public static final TagKey<Enchantment> PROVIDENCE_BONUS = ModEnchantmentTags.bind("providence_bonus");
