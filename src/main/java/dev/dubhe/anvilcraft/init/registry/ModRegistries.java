...
public class ModRegistries {
    public static final Registry<IAmuletEffect.Type<?>> AMULET_EFFECT_TYPE = ModRegistries.simple(
    ...
    public static final Registry<IStorageType<?>> STORAGE_TYPE = ModRegistries.simple(
        ModRegistryKeys.STORAGE_TYPE
    );

    @SubscribeEvent
    public static void registerRegistries(NewRegistryEvent event) {
        event.register(ModRegistries.AMULET_EFFECT_TYPE);
        ...
        event.register(ModRegistries.STORAGE_TYPE);
    }
