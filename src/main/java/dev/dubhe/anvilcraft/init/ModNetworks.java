...
public class ModNetworks {
    ...
    public static final PacketType<SlotDisableChangePack> SLOT_DISABLE_CHANGE_TYPE = Networking.SERVER.register("slot_disable_change", SlotDisableChangePack.class, SlotDisableChangePack::new);
    public static final PacketType<SlotFilterChangePack> SLOT_FILTER_CHANGE_TYPE = Networking.SERVER.register("slot_filter_change", SlotFilterChangePack.class, SlotFilterChangePack::new);
