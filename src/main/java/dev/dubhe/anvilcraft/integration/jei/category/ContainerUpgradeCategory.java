...
public class ContainerUpgradeCategory implements IRecipeCategory<ContainerUpgradeRecipe> {
    ...
    public ContainerUpgradeCategory(IGuiHelper helper) {
        ...
        this.title = Component.translatable("gui.anvilcraft.category.container_upgrade");
        this.dropOnTopTooltip =
            Component.translatable("gui.anvilcraft.category.container_upgrade.drop_on_top")
                .withStyle(ChatFormatting.GOLD);
        this.strikeTooltip =
            Component.translatable("gui.anvilcraft.category.container_upgrade.strike")
                .withStyle(ChatFormatting.GOLD);
        this.requiresExpansion =
            Component.translatable("gui.anvilcraft.category.container_upgrade.requires_expansion")
                .withStyle(ChatFormatting.GOLD);
    }

    @Override
    public RecipeType<ContainerUpgradeRecipe> getRecipeType() {
        return AnvilCraftJeiPlugin.CONTAINER_UPGRADE;
    }
    ...
    public void setRecipe(
        IRecipeLayoutBuilder builder, ContainerUpgradeRecipe recipe, IFocusGroup focuses) {
        switch (recipe.type()) {
            case CRATE_TO_CONTAINER -> {
    ...
    public void createRecipeExtras(
        IRecipeExtrasBuilder builder, ContainerUpgradeRecipe recipe, IFocusGroup focuses) {
        JeiBlockIngredientUtil.suppressHoverOverlays(builder);
    }

    @Override
    public void draw(
        ContainerUpgradeRecipe recipe,
        ...
        switch (recipe.type()) {
            case CRATE_TO_CONTAINER -> RenderSupport.renderBlock(
                guiGraphics,
            ...
            case CONTAINER_TO_STATION -> {
                RenderSupport.renderBlock(
                    guiGraphics,
                    ModBlocks.SHULKER_CONTAINER.getDefaultState()
                        .setValue(ShulkerContainerBlock.HALF, OpenedCube3x3PartHalf.MID_CENTER),
                    81,
                    44,
                    10,
                    8,
    ...
    public static void registerRecipes(IRecipeRegistration registration) {
        registration.addRecipes(
            AnvilCraftJeiPlugin.CONTAINER_UPGRADE,
            ContainerUpgradeRecipe.getAllRecipes()
        );
    }

    public static void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        AnvilCraftJeiPlugin.addAnvilProcessingCatalysts(registration, AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(ModBlocks.LARGE_CRATE.asStack(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(ModBlocks.SPACE_OVERCOMPRESSOR.asStack(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(Blocks.NETHERITE_BLOCK.asItem().getDefaultInstance(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(ModBlocks.SHULKER_CONTAINER.asStack(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(ModBlocks.SINGULARITY_CRYSTAL.asStack(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
        registration.addRecipeCatalyst(ModBlocks.HYPERCUBE.asStack(), AnvilCraftJeiPlugin.CONTAINER_UPGRADE);
    }
}
