    ...
    public static void registerRecipes(IRecipeRegistration registration) {
        ...
        if (!enchantments.isEmpty()) {
            recipes.add(new RecipeHolder<>(
                ResourceKey.create(Registries.RECIPE, AnvilCraft.of("jei/solid_liquid/liquid_enchantment_cleanse")),
        ...
        if (!curses.isEmpty()) {
            recipes.add(new RecipeHolder<>(
                ResourceKey.create(Registries.RECIPE, AnvilCraft.of("jei/solid_liquid/cursed_gold_ingot")),
                LiquidEnchantmentSolidLiquidRecipe.curseGoldIngot(
                    LiquidEnchantmentJeiRecipeUtil.createFluidStacks(curses, 1)
                )
            ));
            recipes.add(new RecipeHolder<>(
                ResourceKey.create(Registries.RECIPE, AnvilCraft.of("jei/solid_liquid/cursed_gold_block")),
