...
public final class StructureScannerRecipeTransferHandler<R extends RecipeHolder<?>>
    ...
    private StructureScannerRecipeTransferHandler(IRecipeType<R> type, IRecipeTransferHandlerHelper helper) {
        this.type = type;
        this.helper = helper;
    }
    ...
    public IRecipeTransferError transferRecipe(
        ...
        if (doTransfer) BlueprintClientFiles.requestRecipe(menu.containerId, recipe.id().identifier());
        return null;
    }
}
