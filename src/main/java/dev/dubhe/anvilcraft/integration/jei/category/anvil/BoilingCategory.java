...
public class BoilingCategory extends AbstractProgressCategory<BoilingRecipe> {
    ...
    public void draw(
        ...
        RenderSupport.renderBlock(graphics, Blocks.CAMPFIRE.defaultBlockState().setValue(CampfireBlock.LIT, true), 71, 35, 20);
        RenderSupport.renderBlock(graphics, CauldronUtil.fullState(Blocks.WATER_CAULDRON), 71, 25, 20);
