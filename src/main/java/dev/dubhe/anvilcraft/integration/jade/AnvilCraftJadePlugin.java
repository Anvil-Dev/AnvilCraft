...
public class AnvilCraftJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(FluidTankProvider.INSTANCE, LargeCauldronBlockEntity.class);
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(FluidTankProvider.INSTANCE, LargeCauldronBlock.class);
