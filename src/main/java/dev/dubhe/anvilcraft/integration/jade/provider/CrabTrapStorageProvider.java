...
public enum CrabTrapStorageProvider implements IServerExtensionProvider<ItemStack> {
    INSTANCE;
    ...
    public List<ViewGroup<ItemStack>> getGroups(Accessor<?> accessor) {
        if (!(accessor.getTarget() instanceof CrabTrapBlockEntity crabTrap)) return List.of();
