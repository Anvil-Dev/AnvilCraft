...
public record AutoEnchantingTableSyncPacket(int index, boolean select) implements IServerboundPacket {
    private static final Type<AutoEnchantingTableSyncPacket> TYPE = IPacket.type(AnvilCraft.of("auto_enchanting_table"));
    ...
    public Type<AutoEnchantingTableSyncPacket> type() {
        return AutoEnchantingTableSyncPacket.TYPE;
    }
