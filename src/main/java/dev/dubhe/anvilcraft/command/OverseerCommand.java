...
public class OverseerCommand {
    ...
    private static int listOverseersInternal(CommandContext<CommandSourceStack> ctx, boolean includeInactive) {
        ...
        MutableComponent msg = Component.translatable("command.anvilcraft.overseer.head", dimension.identifier().toString());
        msg.append(Component.literal("\n").append(Component.translatable(
            "command.anvilcraft.overseer.summary",
            LevelLoadManager.getAllOverseerForcedChunkCount(level)
        )));
        ...
        for (BlockPos pos : overseersPoses) {
            ...
            MutableComponent component = Component.translatable(
                ...
                LevelLoadManager.getOverseerChunkCount(pos)
            );
            msg.append(Component.literal("\n")).append(component);
        }
