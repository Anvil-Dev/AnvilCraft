...
public class TextureConstants {
    ...
    public static final ResourceLocation SHULKER_CONTAINER_CATEGORY_SETTING = TextureConstants.texture(
        "gui/container/shulker_container/category_setting"
    );
    public static final ResourceLocation SHULKER_CONTAINER_CATEGORY_SETTING_BG = TextureConstants.texture(
    ...
    public static final ResourceLocation SHULKER_CONTAINER_REVERSE_ORDER = TextureConstants.texture(
        "gui/container/shulker_container/reverse_order"
    );

    public static final ResourceLocation SHULKER_CONTAINER_SEARCH_CLEAR = TextureConstants.texture(
        "gui/container/shulker_container/search_clear"
    );
    public static final ResourceLocation SHULKER_CONTAINER_SEARCH_RETENTION = TextureConstants.texture(
        "gui/container/shulker_container/search_retention"
    );

    public static final ResourceLocation SHULKER_CONTAINER_SORT_BY_NUMBER = TextureConstants.texture(
        "gui/container/shulker_container/sort_by_number"
    );
    public static final ResourceLocation SHULKER_CONTAINER_SORT_BY_MOD = TextureConstants.texture(
        "gui/container/shulker_container/sort_by_mod"
    );
    public static final ResourceLocation SHULKER_CONTAINER_SORT_BY_NAME = TextureConstants.texture(
        "gui/container/shulker_container/sort_by_name"
    );

    public static final ResourceLocation SHULKER_CONTAINER_SLIDER_BIG = TextureConstants.texture(
        "gui/container/shulker_container/slider_big"
    );
    public static final ResourceLocation SHULKER_CONTAINER_SLIDER_SMALL = TextureConstants.texture(
