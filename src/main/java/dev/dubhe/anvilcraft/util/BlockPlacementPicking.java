...
public final class BlockPlacementPicking {
    ...
    @Nullable
    public static InteractionResult tryPlaceFromAir(ItemStack stack, Level level, Player player, InteractionHand hand) {
        BlockHitResult hit = findAirPlacementHit(stack, level, player);
        if (hit == null) return null;
        return stack.useOn(new UseOnContext(level, player, hand, stack, hit));
    }
