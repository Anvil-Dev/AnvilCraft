...
public record Atmosphere(Map<Identifier, Double> gases) {
    public static final Identifier NITROGEN = AnvilCraft.of("nitrogen");
    public static final Identifier OXYGEN = AnvilCraft.of("oxygen");
    ...
    public double gasAmount(Identifier gas) {
