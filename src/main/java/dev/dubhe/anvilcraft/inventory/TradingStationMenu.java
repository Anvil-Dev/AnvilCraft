...
public class TradingStationMenu extends AbstractContainerMenu implements IFilterMenu {
    ...
    public TradingStationMenu(@Nullable MenuType<?> menuType, int containerId, Inventory inventory, TradingStationBlockEntity be) {
        ...
        this.be = be;
        be.setOwner(inventory.player.getGameProfile().id());
            ...
            for (int column = 0; column < 4; ++column) {
                ...
                this.addSlot(new SlotItemHandlerWithFilter(
                    ...
                    public boolean mayPlace(ItemStack stack) {
                        return TradingStationMenu.this.be.getHandler().isValid(storageSlot, ItemResource.of(stack));
                    }
                });
            }
        }
        ...
        this.addSlot(new FilterOnlySlot(this.be.getFilters(), 0, 8, 25) {
            ...
            public void set(ItemStack stack) {
                if (TradingStationMenu.this.level.isClientSide()) {
                    ClientPacketDistributor.sendToServer(new TradingStationPackets.SyncFilter(
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (index < TradingStationMenu.VANILLA_FIRST_SLOT_INDEX + TradingStationMenu.VANILLA_SLOT_COUNT) {
    ...
    private boolean moveItemToActiveSlot(ItemStack stack) {
        ...
        for (int index = TradingStationMenu.TE_INVENTORY_FIRST_SLOT_INDEX; index < 48; index++) {
    ...
    public int getFilterSlotIndex(Slot slot) {
        return slot.index - TradingStationMenu.TE_INVENTORY_FIRST_SLOT_INDEX;
    }
