...
public class AutoEnchantingTableMenu extends AbstractContainerMenu {
    ...
    public AutoEnchantingTableMenu(
        ...
        this.addSlot(new ResourceHandlerSlot(
            this.blockEntity.getItemHandler(), (slot, resource, count) -> {
                this.blockEntity.getItemHandler().set(slot, resource, count);
        ...
        this.refreshEnchantments();
        this.lastPrimerStack = this.blockEntity.getItem(AutoEnchantingTableBlockEntity.SLOT_PRIMER).copy();
    }
    ...
    private void refreshEnchantments() {
        ...
        ItemStack primer = this.blockEntity.getItem(AutoEnchantingTableBlockEntity.SLOT_PRIMER);
