...
public class TooltipEventListener {
    ...
    public static void onTooltip(AppendCustomHoverTextEvent event) {
        ...
        stack.addUnitComponentToTooltip(ModComponents.FIRE_REFORGING, TooltipEventListener.FIRE_REFORGING, display, builder);
        ...
        TooltipEventListener.addShiftUnitTooltip(
            ModComponents.PROVIDENCE,
            TooltipEventListener.PROVIDENCE,
            TooltipEventListener.PROVIDENCE_SHIFT,
            stack,
            shift,
            display,
            builder
