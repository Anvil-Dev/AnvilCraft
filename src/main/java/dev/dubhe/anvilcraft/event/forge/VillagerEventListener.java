...
public class VillagerEventListener {
    ...
    public static void addCustomTrades(@NotNull VillagerTradesEvent event) {
        ...
        //                new ItemStack(Items.EMERALD, 40), new ItemStack(ModItems.ROYAL_STEEL_INGOT,
        // 4),
        ...
        //                new ItemStack(Items.NAUTILUS_SHELL), ItemStack.EMPTY, new
        // ItemStack(Items.EMERALD, 2),
        //                12, 10, 0.05f
        //            ));
        //            trades.get(4).add((entity, random) -> ((int) (random.nextDouble() * 2)) == 1 ? new
        // MerchantOffer(
        //                new ItemStack(ModBlocks.MOB_AMBER_BLOCK), ItemStack.EMPTY, new
        // ItemStack(Items.EMERALD, 8),
        //                2, 10, 0.05f
        //            ) : new MerchantOffer(
        //                new ItemStack(ModBlocks.RESENTFUL_AMBER_BLOCK), ItemStack.EMPTY, new
