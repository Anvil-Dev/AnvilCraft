...
public class SuperCapacitorItem extends Item implements IFullCapacitor, IChargerDischargeable {
    ...
    public ItemStack getEmpty(ItemStack full) {
        return full.transmuteCopy(ModItems.SUPER_CAPACITOR_EMPTY, 1);
    }
