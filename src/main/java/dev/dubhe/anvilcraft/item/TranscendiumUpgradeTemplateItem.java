...
public class TranscendiumUpgradeTemplateItem extends SmithingTemplateItem {
    ...
    private static final Component UPGRADE_INGREDIENTS =
        Component.translatable("screen.anvilcraft.smithing_template.transcendium_upgrade_smithing_template.upgrade_ingredients")
            .withStyle(DESCRIPTION_FORMAT);
    private static final Component UPGRADE = Component.translatable(
            "screen.anvilcraft.transcendium_upgrade_smithing_template")
    ...
    public TranscendiumUpgradeTemplateItem(Properties properties) {
        super(
            APPLIES_TO,
            UPGRADE_INGREDIENTS,
            UPGRADE,
