...
public class CorruptedBeaconActivatorItem extends EnergyWeaponItem {
    ...
    public void onUseTick(Level level, LivingEntity user, ItemStack stack, int remaining) {
        ...
        for (LivingEntity target : WeaponRaycastUtil.livingEntitiesToEnd(
            level, player, ray, Integer.MAX_VALUE)) {
            ...
            if (wither != null && elapsed > 0 && elapsed % 40 < period) {
                amplifier = Math.min(4, amplifier + 1);
            }
