...
public class TeslaGunItem extends Item {
    ...
    public TeslaGunItem(Properties properties) {
        super(properties.component(ModComponents.STORED_ENERGY, TeslaGunItem.MAX_ENERGY));
    }
    ...
    public int getBarWidth(ItemStack stack) {
        ...
        return Math.round(Math.clamp((float) energy / TeslaGunItem.MAX_ENERGY, 0, 1) * 13);
    }

    @Override
    public int getBarColor(ItemStack stack) {
        float energy = stack.getOrDefault(ModComponents.STORED_ENERGY, 0);
        return ColorUtil.lerpColor(energy / TeslaGunItem.MAX_ENERGY, BAR_COLOR, FULL_BAR_COLOR);
    }
}
