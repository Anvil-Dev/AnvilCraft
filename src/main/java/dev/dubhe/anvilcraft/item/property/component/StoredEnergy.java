...
public record StoredEnergy(int energy) implements TooltipProvider {
    ...
    public void addToTooltip(Item.TooltipContext context, Consumer<Component> consumer, TooltipFlag flag, DataComponentGetter components) {
        consumer.accept(Component.translatable(
            ...
            UnitUtil.energyUnit(components.getOrDefault(ModComponents.STORED_ENERGY, StoredEnergy.EMPTY).energy(), flag.hasShiftDown())
