...
public class ShulkerContainerBlockEntity extends StorageBlockEntity {
    ...
    public void recheckOpeners() {
        ...
        for (ContainerUser opener : this.openersCounter.getEntitiesWithContainerOpen(this.level, this.worldPosition)) {
            if (opener.getLivingEntity() instanceof Player player) {
