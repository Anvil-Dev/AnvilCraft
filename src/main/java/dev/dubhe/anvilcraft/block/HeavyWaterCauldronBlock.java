...
public class HeavyWaterCauldronBlock extends BetterAbstractCauldronBlock implements IHammerRemovable {

    public HeavyWaterCauldronBlock(Properties properties) {
        super(properties, ModInteractionMap.HEAVY_WATER);
    }
