...
public class FastCookingRecipe extends AbstractProcessRecipe<FastCookingRecipe> {
    ...
    public static final RecipeSerializer<FastCookingRecipe> SERIALIZER = new RecipeSerializer<>(
        FastCookingRecipe.CODEC, FastCookingRecipe.STREAM_CODEC);
    ...
    public RecipeSerializer<FastCookingRecipe> getSerializer() {
        return ModRecipeSerializers.FAST_COOKING.get();
    }

    @Override
    public RecipeType<FastCookingRecipe> getType() {
        return ModRecipeTypes.FAST_COOKING.get();
    }
