...
public record ResentmentAmberOutcome(Vec3 offset, Identifier savedEntityPath)
    ...
    public void accept(InWorldRecipeContext context) {
        ...
        SpawnItem.builder()
            .item(ItemStackTemplate.fromNonEmptyStack(result))
            .offset(this.offset)
            .build()
            .accept(context);
    }
    ...
    public static class Type implements IRecipeOutcome.Type<ResentmentAmberOutcome> {
        public static final MapCodec<ResentmentAmberOutcome> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                ...
                Identifier.CODEC.fieldOf("saved_entity_path").forGetter(ResentmentAmberOutcome::savedEntityPath)
