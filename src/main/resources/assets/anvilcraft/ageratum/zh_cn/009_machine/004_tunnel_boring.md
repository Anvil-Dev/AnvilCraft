...
- 通过红石激活[<translate key="block.anvilcraft.block_devourer"/>](../004_block/101_block_devourer.md)，不断破坏掉前方3x3范围的方块
- 可以在开掘出的隧道中修建交通，或者挖矿
...
1. 搭建方块时，红石块要在最后放置
2. 铁轨上放置存储矿车
3. 更新 <translate key="block.minecraft.sticky_piston"/> 启动机器
4. 要停下就把机器拆了
...
从 2 格高落下的铁砧会使被砸到的[<translate key="block.anvilcraft.block_devourer"/>](../004_block/101_block_devourer.md)挖掘前方 7x7 的方块
...
4. 更新 <translate key="block.minecraft.sticky_piston"/> 启动机器
5. 要停下就把机器拆了
