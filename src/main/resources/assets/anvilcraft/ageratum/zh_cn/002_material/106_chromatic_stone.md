...
- 源头与水接触时，变为<translate key="block.anvilcraft.chromatic_stone"/>
- 流动部分与水接触时，变为<translate key="block.minecraft.granite"/>、<translate key="block.minecraft.diorite"/>或<translate key="block.minecraft.andesite"/>
