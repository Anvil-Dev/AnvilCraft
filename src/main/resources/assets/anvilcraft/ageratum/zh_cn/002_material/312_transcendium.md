...
|:--------:|:-------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------:|
| [0, 10]  |                      n * 10%                      | 4 <item id="anvilcraft:transcendium_ingot"/> + 3*n <item id="anvilcraft:transcendium_nugget"/> |
| [11, 14] |                       100%                        | 4 <item id="anvilcraft:transcendium_ingot"/> + 3*n <item id="anvilcraft:transcendium_nugget"/> |
|    15    |                       100%                        |                                   1 <item id="anvilcraft:transcendium_block"/>                                   |
| [16, +∞) |                       100%                        |  1 <item id="anvilcraft:transcendium_block"/> + n <item id="anvilcraft:transcendium_nugget"/>  |
