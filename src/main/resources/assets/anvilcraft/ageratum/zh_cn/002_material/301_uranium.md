...
- 时移<ref item="anvilcraft:uranium_block"/>会在一瞬间爆发出通常需要数万年才能释放的能量,
  将与锅水平相邻的[可加热方块](../001_feature/101_heated_block.md#可加热方块)加热为<color=#ee7744>白炽</color>并持续5min，合计 1024kW
- 通过铁砧撞击<ref item="anvilcraft:uranium_block"/>，加热至多16个<ref item="anvilcraft:overheated_ember_metal_block"/>并持续20s，合计
  16384kW."
