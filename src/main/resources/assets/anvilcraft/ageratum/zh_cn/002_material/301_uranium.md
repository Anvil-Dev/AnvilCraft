...
- 每个[<translate key="block.anvilcraft.uranium_block"/>](301_uranium.md)为[<translate key="item.anvilcraft.heat_collector"/>](../003_power/201_heat_collection.md)提供 2kW 的发电量
- 时移[<translate key="block.anvilcraft.uranium_block"/>](301_uranium.md)会在一瞬间爆发出通常需要数万年才能释放的能量,
  将与锅水平相邻的[可加热方块](../001_feature/101_heated_block.md#可加热方块)加热为<color=#ffccaa>白炽</color>并持续5min，合计 1024kW
