...
在[<translate key="item.anvilcraft.royal_grindstone"/>](../005_block/102_royal_grindstone.md)上使用金锭(块)驱除诅咒附魔或附魔惩罚以获得

# 功能

- 制作[<translate key="item.anvilcraft.corrupted_beacon"/>](../005_block/200_corrupted_beacon.md)
