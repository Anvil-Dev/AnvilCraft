...
# [<translate key="item.anvilcraft.acceleration_ring"/>](215_large_electromagnet.md)

- 通过[多方块转化](../005_block/210_giant_anvil.md#功能)获得
- 启用耗电量256kW，受到红石信号停用
- 朝上摆放时，启用时，可以吸引12格以内的[<translate key="item.anvilcraft.giant_anvil"/>](210_giant_anvil.md)。中间不能有方块阻挡
...
# [<translate key="item.anvilcraft.deflection_ring"/>](215_large_electromagnet.md)

- 通过[多方块转化](../005_block/210_giant_anvil.md#功能)获得
- 启用耗电量256kW，受到红石信号停用
- 竖直摆放时，启用时，可以吸引12格以内的[<translate key="item.anvilcraft.giant_anvil"/>](210_giant_anvil.md)。中间不能有方块阻挡
...
<GameScene zoom="1" interactive={true}>
    <structure id="../ac_assets/structure/accelerate_machine.snbt"/>
</GameScene>
...
<GameScene zoom="2" interactive={true}>
    <structure id="../ac_assets/structure/collision_room.snbt"/>
</GameScene>

## 控制速度

- <translate key="item.minecraft.comparator"/>可以从[<translate key="item.anvilcraft.deflection_ring"/>](215_large_electromagnet.md)读取经过的铁砧的速度(单位: m/tick)并输出红石信号
...
1. 检测铁砧达到一定速度后，对[<translate key="item.anvilcraft.deflection_ring"/>](215_large_electromagnet.md)施加红石信号使其失效
2. 铁砧就可以从此处飞出加速装置，进入撞击室
3. 别忘了提前通过铁砧砸击[<translate key="block.anvilcraft.block_placer"/>](001_block_placer.md)，使其隔着墙壁放置被撞击方块
4. 使用[<translate key="item.anvilcraft.item_collector"/>](101_item_collector.md)隔墙收集
