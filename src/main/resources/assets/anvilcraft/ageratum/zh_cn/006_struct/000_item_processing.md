...
让<translate key="item.minecraft.anvil"/>落在特定方块上就可以加工该方块顶部或内部的物品，不同的特定方块有不同的处理，本条目的后续页面依次介绍
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/item_stamping.snbt"/></GameScene>
<Column>
下方是[<translate key="item.anvilcraft.stamping_platform"/>](000_item_processing.md)时，执行**物品冲压**操作，产物会从平台前掉出
- 铁锭→铁压力板 
- 金锭→金压力板 
- 雪球→雪片 
- 樱花树叶→粉色花瓣 
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/item_crush.snbt"/></GameScene>

<Column>
下方是[<translate key="item.anvilcraft.crushing_table"/>](000_item_processing.md)时，执行**物品粉碎**操作，原料放在平台上，产物从下方掉出
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/item_compress.snbt"/></GameScene>
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/unpack.snbt"/></GameScene>
<Column>
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/mesh.snbt"/></GameScene>
<Column>
下方是<translate key="item.minecraft.scaffolding"/>时，执行**物品过筛**操作，原料置于脚手架上，产物出现在脚手架下
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/bulging.snbt"/></GameScene>
<Column>
...
<row halign="center">
<GameScene zoom="2"><structure id="../ac_assets/structure/cooking.snbt"/></GameScene>
<Column>
下方是<translate key="item.minecraft.cauldron"/>和<translate key="item.minecraft.campfire"/>时，
