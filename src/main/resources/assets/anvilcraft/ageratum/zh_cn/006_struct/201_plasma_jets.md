...
- 炼药锅底部有工作的[<translate key="item.anvilcraft.heater"/>](../005_block/100_heater.md)
- 炼药锅正上方 1x8x1 的空间没有方块
- 管壁最高可为四格

# 功能

- 将作为管壁的[常规可加热方块](../001_feature/101_heated_block.md)加热至<color=#cc8844>炽热</color>并增加0.1秒持续时间
- 若某层管壁符合对侧为[<translate key="block.anvilcraft.magnet_block"/>](../002_material/001_magnet.md)、另一对侧为[常规可加热方块](../001_feature/101_heated_block.md)时：
    - 将该层的[常规可加热方块](../001_feature/101_heated_block.md)加热至<color=#cc8844>炽热</color>并增加1秒持续时间
