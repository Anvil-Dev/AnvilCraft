...
<tip>
Some items duplicated by the <ref item="anvilcraft:jewelcrafting_table"/> (<ref item="minecraft:totem_of_undying"/> and [various amulets](../006_prop/100_amulet.md)) carry the Curse of Vanishing, which can be used to mass-produce cursed gold
</tip>
