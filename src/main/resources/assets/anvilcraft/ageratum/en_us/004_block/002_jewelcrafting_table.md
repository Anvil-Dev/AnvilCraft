...
<row halign="center">
All banner patterns, music discs, pottery sherds, and armor trim smithing templates can be replicated using the recipes above
</row>

# Properties

- Can serve as a villager workstation, providing the [Jeweler](../001_feature/001_jeweler.md) profession