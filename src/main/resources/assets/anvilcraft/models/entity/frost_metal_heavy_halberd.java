...
public class frost_metal_heavy_halberd<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "frost_metal_heavy_halberd"), "main");
	private final ModelPart group2;
	private final ModelPart group;
	private final ModelPart bone;

	public frost_metal_heavy_halberd(ModelPart root) {
