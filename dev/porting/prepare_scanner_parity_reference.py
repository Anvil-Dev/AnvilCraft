...
relative = "src/main/java/dev/dubhe/anvilcraft/porting/ScannerVisualParityScene.java"
scene = (root / "dev/porting/java/dev/dubhe/anvilcraft/porting/ScannerVisualParityScene.java").read_text(encoding="utf-8")
...
setting = "neoForge.runs.client { systemProperty 'anvilcraft.portScannerVisualParityScene', 'true' }"
