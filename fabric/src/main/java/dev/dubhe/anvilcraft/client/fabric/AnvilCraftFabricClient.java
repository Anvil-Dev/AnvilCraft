...
public class AnvilCraftFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(
                ModBlocks.MOB_AMBER_BLOCK.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(
                ModBlocks.RESENTFUL_AMBER_BLOCK.get(), RenderType.translucent());
        BlockRenderLayerMap.INSTANCE.putBlock(
                ModBlocks.TEMPERING_GLASS.get(), RenderType.translucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(
                ModBlocks.JEWEL_CRAFTING_TABLE.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(
                ModBlocks.PIEZOELECTRIC_CRYSTAL.get(), RenderType.translucent());
        ...
        WorldRenderEvents.AFTER_ENTITIES.register(context -> {
            ...
            IBlockHighlightUtil.render(
                    context.world(), consumers, context.matrixStack(), context.camera());
        });

        ItemTooltipCallback.EVENT.register(
                (stack, context, lines) -> TooltipEventListener.addTooltip(stack, lines));
    }
}
